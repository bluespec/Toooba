...
//
// On Wed Mar 25 14:02:12 GMT 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkSoC_Map(CLK,
  ...
  wire [63 : 0] x__h118, x__h142, x__h187, x__h211, x__h236, x__h263;
  ...
  assign m_is_mem_addr =
	     ...
	     x__h118 < 64'h0000000000001000 ||
	     m_is_mem_addr_addr >= 64'h0000000080000000 &&
	     x__h142 < 64'h0000000040000000 ;

  // value method m_is_IO_addr
  assign m_is_IO_addr =
	     m_is_IO_addr_addr >= 64'h0000000002000000 &&
	     x__h187 < 64'h000000000000C000 ||
	     m_is_IO_addr_addr >= 64'h000000000C000000 &&
	     x__h211 < 64'h0000000000400000 ||
	     m_is_IO_addr_addr >= 64'h00000000C0000000 &&
	     x__h236 < 64'h0000000000000080 ;

  // value method m_is_near_mem_IO_addr
  assign m_is_near_mem_IO_addr =
	     m_is_near_mem_IO_addr_addr >= 64'h0000000002000000 &&
	     x__h263 < 64'h000000000000C000 ;
  ...
  // remaining internal signals
  assign x__h118 = m_is_mem_addr_addr - 64'h0000000000001000 ;
  assign x__h142 = m_is_mem_addr_addr - 64'h0000000080000000 ;
  assign x__h187 = m_is_IO_addr_addr - 64'h0000000002000000 ;
  assign x__h211 = m_is_IO_addr_addr - 64'h000000000C000000 ;
  assign x__h236 = m_is_IO_addr_addr - 64'h00000000C0000000 ;
  assign x__h263 = m_is_near_mem_IO_addr_addr - 64'h0000000002000000 ;
endmodule  // mkSoC_Map
