...
//
// On Wed Mar 25 12:41:10 GMT 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkAluRegToExeFifo(CLK,
  ...
  reg [20 : 0] CASE_enq_x_BITS_416_TO_414_0_enq_x_BITS_416_TO_ETC__q5,
	       CASE_m_m_row_0_BITS_404_TO_402_0_m_m_row_0_BIT_ETC__q2;
  reg [11 : 0] CASE_enq_x_BITS_394_TO_383_1_enq_x_BITS_394_TO_ETC__q6,
	       CASE_m_m_row_0_BITS_382_TO_371_1_m_m_row_0_BIT_ETC__q3;
  reg [2 : 0] CASE_enq_x_BITS_399_TO_397_0_enq_x_BITS_399_TO_ETC__q4,
	      CASE_m_m_row_0_BITS_387_TO_385_0_m_m_row_0_BIT_ETC__q1;
  wire [11 : 0] sb__h7538, upd__h1152;
  ...
  assign m_m_specBits_0_lat_1$wget =
	     sb__h7538 & specUpdate_correctSpeculation_mask ;

  // register m_m_row_0
  assign m_m_row_0$D_IN =
	     { enq_x[421:417],
	       CASE_enq_x_BITS_416_TO_414_0_enq_x_BITS_416_TO_ETC__q5,
	       enq_x[395],
	       CASE_enq_x_BITS_394_TO_383_1_enq_x_BITS_394_TO_ETC__q6,
	       enq_x[382:12] } ;
  assign m_m_row_0$EN = EN_enq ;

  // register m_m_specBits_0_rl
  assign m_m_specBits_0_rl$D_IN =
	     EN_specUpdate_correctSpeculation ? upd__h1152 : sb__h7538 ;
  ...
  assign sb__h7538 = EN_enq ? enq_x[11:0] : m_m_specBits_0_rl ;
  ...
  begin
    case (m_m_row_0[387:385])
	  ...
	  CASE_m_m_row_0_BITS_387_TO_385_0_m_m_row_0_BIT_ETC__q1 =
	      m_m_row_0[387:385];
      default: CASE_m_m_row_0_BITS_387_TO_385_0_m_m_row_0_BIT_ETC__q1 = 3'd7;
    endcase
  end
  always@(m_m_row_0 or CASE_m_m_row_0_BITS_387_TO_385_0_m_m_row_0_BIT_ETC__q1)
  begin
    case (m_m_row_0[404:402])
	  ...
	  CASE_m_m_row_0_BITS_404_TO_402_0_m_m_row_0_BIT_ETC__q2 =
		...
		CASE_m_m_row_0_BITS_387_TO_385_0_m_m_row_0_BIT_ETC__q1,
		m_m_row_0[384] };
      default: CASE_m_m_row_0_BITS_404_TO_402_0_m_m_row_0_BIT_ETC__q2 =
		   21'd1485482;
    endcase
  end
  always@(m_m_row_0)
  begin
    case (m_m_row_0[382:371])
	  ...
	  CASE_m_m_row_0_BITS_382_TO_371_1_m_m_row_0_BIT_ETC__q3 =
	      m_m_row_0[382:371];
      default: CASE_m_m_row_0_BITS_382_TO_371_1_m_m_row_0_BIT_ETC__q3 =
		   12'd2303;
    endcase
  end
  always@(enq_x)
  begin
    case (enq_x[399:397])
      3'd0, 3'd1, 3'd2, 3'd3, 3'd4:
	  CASE_enq_x_BITS_399_TO_397_0_enq_x_BITS_399_TO_ETC__q4 =
	      enq_x[399:397];
      default: CASE_enq_x_BITS_399_TO_397_0_enq_x_BITS_399_TO_ETC__q4 = 3'd7;
    endcase
  end
  always@(enq_x or CASE_enq_x_BITS_399_TO_397_0_enq_x_BITS_399_TO_ETC__q4)
  begin
    case (enq_x[416:414])
      3'd0, 3'd1, 3'd2, 3'd3:
	  CASE_enq_x_BITS_416_TO_414_0_enq_x_BITS_416_TO_ETC__q5 =
	  ...
	  CASE_enq_x_BITS_416_TO_414_0_enq_x_BITS_416_TO_ETC__q5 =
		...
		CASE_enq_x_BITS_399_TO_397_0_enq_x_BITS_399_TO_ETC__q4,
		enq_x[396] };
      default: CASE_enq_x_BITS_416_TO_414_0_enq_x_BITS_416_TO_ETC__q5 =
		   21'd1485482;
    endcase
  end
  always@(enq_x)
  begin
    case (enq_x[394:383])
	  ...
	  CASE_enq_x_BITS_394_TO_383_1_enq_x_BITS_394_TO_ETC__q6 =
	      enq_x[394:383];
      default: CASE_enq_x_BITS_394_TO_383_1_enq_x_BITS_394_TO_ETC__q6 =
		   12'd2303;
    endcase
  end
