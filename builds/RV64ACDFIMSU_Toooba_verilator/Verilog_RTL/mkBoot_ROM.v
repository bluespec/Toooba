...
//
// On Wed Mar 25 14:02:25 GMT 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkBoot_ROM(CLK,
  ...
  reg [63 : 0] data64__h2400;
  reg [31 : 0] CASE_byte_addr098_16_0x0_24_0x0_32_0x54040000__ETC__q1,
	       CASE_byte_addr098_16_0x28067_24_0x80000000_32__ETC__q2;
  wire [63 : 0] byte_addr__h2098, rdata__h2340;
  ...
  assign byte_addr__h2098 =
	     slave_xactor_shim_arff$D_OUT[92:29] - rg_addr_base ;
  assign rdata__h2340 =
	     NOT_slave_xactor_shim_arff_first__0_BITS_31_TO_ETC___d62 ?
	       64'd0 :
	       data64__h2400 ;
  always@(byte_addr__h2098)
  begin
    case (byte_addr__h2098)
      64'd16,
      64'd24,
      64'd56,
      64'd72,
      ...
      64'd4080,
      64'd4088:
	  CASE_byte_addr098_16_0x0_24_0x0_32_0x54040000__ETC__q1 = 32'h0;
      64'd32:
	  CASE_byte_addr098_16_0x0_24_0x0_32_0x54040000__ETC__q1 =
	      32'h54040000;
      64'd40:
	  CASE_byte_addr098_16_0x0_24_0x0_32_0x54040000__ETC__q1 =
	      32'h88030000;
	  ...
	  CASE_byte_addr098_16_0x0_24_0x0_32_0x54040000__ETC__q1 =
	      32'h68732D67;
      default: CASE_byte_addr098_16_0x0_24_0x0_32_0x54040000__ETC__q1 =
		   32'hAAAAAAAA;
    endcase
  end
  always@(byte_addr__h2098)
  begin
    case (byte_addr__h2098)
      ...
      64'd4080,
      64'd4088:
	  CASE_byte_addr098_16_0x28067_24_0x80000000_32__ETC__q2 = 32'h0;
	  ...
	  CASE_byte_addr098_16_0x28067_24_0x80000000_32__ETC__q2 =
	      32'h00746669;
      default: CASE_byte_addr098_16_0x28067_24_0x80000000_32__ETC__q2 =
		   32'hAAAAAAAA;
    endcase
  end
  always@(byte_addr__h2098 or
	  CASE_byte_addr098_16_0x0_24_0x0_32_0x54040000__ETC__q1 or
	  CASE_byte_addr098_16_0x28067_24_0x80000000_32__ETC__q2)
  begin
    case (byte_addr__h2098)
      64'd0: data64__h2400 = 64'h0202859300000297;
      64'd8: data64__h2400 = 64'h0182B283F1402573;
      default: data64__h2400 =
		   { CASE_byte_addr098_16_0x0_24_0x0_32_0x54040000__ETC__q1,
		     CASE_byte_addr098_16_0x28067_24_0x80000000_32__ETC__q2 };
    endcase
  end
