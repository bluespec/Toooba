...
//
// On Tue Aug 31 13:04:22 EDT 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkEpochManager(CLK,
  ...
  wire [3 : 0] _theResult____h5127, checkedEpoch__h5173, next_epoch__h81;
  wire IF_NOT_updatePrevEn_1_dummy2_1_read__5_6_OR_IF_ETC___d29,
       IF_updatePrevEn_0_dummy2_1_read__3_AND_IF_upda_ETC___d67,
       NOT_IF_updatePrevEn_0_dummy2_1_read__3_AND_IF__ETC___d69,
       NOT_prev_checked_epoch_4_ULE_updatePrevEpoch_0_ETC___d57,
       NOT_updatePrevEn_0_dummy2_1_read__3_0_OR_IF_up_ETC___d34,
       NOT_updatePrevEn_1_dummy2_1_read__5_6_OR_IF_up_ETC___d22,
       NOT_updatePrevEpoch_0_update_e_ULE_curr_epoch_2_8___d59,
       NOT_updatePrevEpoch_1_update_e_ULE_curr_epoch_2_0___d71,
       prev_checked_epoch_4_ULE_curr_epoch_2___d55,
       updatePrevEn_0_dummy2_1_read__3_AND_IF_updateP_ETC___d27;
  ...
  assign prev_checked_epoch$EN =
	     IF_NOT_updatePrevEn_1_dummy2_1_read__5_6_OR_IF_ETC___d29 ;

  // register updatePrevEn_0_rl
  assign updatePrevEn_0_rl$D_IN = 5'd10 ;
  assign updatePrevEn_0_rl$EN = 1'd1 ;

  // register updatePrevEn_1_rl
  assign updatePrevEn_1_rl$D_IN = 5'd10 ;
  ...
  // remaining internal signals
  assign IF_NOT_updatePrevEn_1_dummy2_1_read__5_6_OR_IF_ETC___d29 =
	     NOT_updatePrevEn_1_dummy2_1_read__5_6_OR_IF_up_ETC___d22 ?
	       updatePrevEn_0_dummy2_1_read__3_AND_IF_updateP_ETC___d27 :
	       (EN_updatePrevEpoch_1_update ?
		  updatePrevEn_1_lat_0$wget[4] :
		  updatePrevEn_1_rl[4]) ;
  assign IF_updatePrevEn_0_dummy2_1_read__3_AND_IF_upda_ETC___d67 =
	     _theResult____h5127 <= curr_epoch ;
  assign NOT_IF_updatePrevEn_0_dummy2_1_read__3_AND_IF__ETC___d69 =
	     _theResult____h5127 > updatePrevEpoch_1_update_e ;
  assign NOT_prev_checked_epoch_4_ULE_updatePrevEpoch_0_ETC___d57 =
	     prev_checked_epoch > updatePrevEpoch_0_update_e ;
  assign NOT_updatePrevEn_0_dummy2_1_read__3_0_OR_IF_up_ETC___d34 =
	     !updatePrevEn_0_dummy2_1$Q_OUT ||
	     (EN_updatePrevEpoch_0_update ?
		!updatePrevEn_0_lat_0$wget[4] :
		!updatePrevEn_0_rl[4]) ;
  assign NOT_updatePrevEn_1_dummy2_1_read__5_6_OR_IF_up_ETC___d22 =
	     !updatePrevEn_1_dummy2_1$Q_OUT ||
	     (EN_updatePrevEpoch_1_update ?
		!updatePrevEn_1_lat_0$wget[4] :
		!updatePrevEn_1_rl[4]) ;
  assign NOT_updatePrevEpoch_0_update_e_ULE_curr_epoch_2_8___d59 =
	     updatePrevEpoch_0_update_e > curr_epoch ;
  assign NOT_updatePrevEpoch_1_update_e_ULE_curr_epoch_2_0___d71 =
	     updatePrevEpoch_1_update_e > curr_epoch ;
  assign _theResult____h5127 =
	     updatePrevEn_0_dummy2_1_read__3_AND_IF_updateP_ETC___d27 ?
	       checkedEpoch__h5173 :
	       prev_checked_epoch ;
  assign checkedEpoch__h5173 =
	     EN_updatePrevEpoch_0_update ?
	       updatePrevEn_0_lat_0$wget[3:0] :
	       updatePrevEn_0_rl[3:0] ;
  assign next_epoch__h81 = (curr_epoch == 4'd11) ? 4'd0 : curr_epoch + 4'd1 ;
  assign prev_checked_epoch_4_ULE_curr_epoch_2___d55 =
	     prev_checked_epoch <= curr_epoch ;
  assign updatePrevEn_0_dummy2_1_read__3_AND_IF_updateP_ETC___d27 =
	     updatePrevEn_0_dummy2_1$Q_OUT &&
	     (EN_updatePrevEpoch_0_update ?
		updatePrevEn_0_lat_0$wget[4] :
		updatePrevEn_0_rl[4]) ;
  ...
  begin
	...
	$finish(32'd0);
    if (RST_N != `BSV_RESET_VALUE)
      if (IF_NOT_updatePrevEn_1_dummy2_1_read__5_6_OR_IF_ETC___d29 &&
	  NOT_updatePrevEn_1_dummy2_1_read__5_6_OR_IF_up_ETC___d22 &&
	  NOT_updatePrevEn_0_dummy2_1_read__3_0_OR_IF_up_ETC___d34)
	$fdisplay(32'h80000002, "\n%m: ASSERT FAIL!!");
    if (RST_N != `BSV_RESET_VALUE)
