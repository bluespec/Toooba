...
//
// On Tue Aug 31 13:07:26 EDT 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkRas(CLK,
  ...
  wire [63 : 0] IF_stack_0_lat_0_whas_THEN_IF_stack_0_lat_0_wh_ETC___d11,
		IF_stack_1_lat_0_whas__0_THEN_IF_stack_1_lat_0_ETC___d24,
		IF_stack_2_lat_0_whas__3_THEN_IF_stack_2_lat_0_ETC___d37,
		IF_stack_3_lat_0_whas__6_THEN_IF_stack_3_lat_0_ETC___d50,
		IF_stack_4_lat_0_whas__9_THEN_IF_stack_4_lat_0_ETC___d63,
		IF_stack_5_lat_0_whas__2_THEN_IF_stack_5_lat_0_ETC___d76,
		IF_stack_6_lat_0_whas__5_THEN_IF_stack_6_lat_0_ETC___d89,
		IF_stack_7_lat_0_whas__8_THEN_IF_stack_7_lat_0_ETC___d102,
		n__read__h14315,
		n__read__h14317,
		n__read__h14319,
		n__read__h14321,
		...
		n__read__h16855,
		n__read__h16857;
  wire [2 : 0] IF_head_lat_0_whas__11_THEN_IF_head_lat_0_whas_ETC___d115,
	       _theResult____h15795,
	       _theResult____h17528,
	       h___1__h15874,
	       h___1__h17604,
	       h__h15794,
	       upd__h13212,
  ...
  always@(h__h15794 or
	  ...
	  n__read__h14321 or
	  n__read__h14323 or
	  n__read__h14325 or n__read__h14327 or n__read__h14329)
  begin
    case (h__h15794)
      3'd0: ras_0_first = n__read__h14315;
      3'd1: ras_0_first = n__read__h14317;
      3'd2: ras_0_first = n__read__h14319;
      3'd3: ras_0_first = n__read__h14321;
      3'd4: ras_0_first = n__read__h14323;
      3'd5: ras_0_first = n__read__h14325;
      3'd6: ras_0_first = n__read__h14327;
      3'd7: ras_0_first = n__read__h14329;
    endcase
  end
  ...
  always@(x__h16723 or
	  ...
	  n__read__h16849 or
	  n__read__h16851 or
	  n__read__h16853 or n__read__h16855 or n__read__h16857)
  begin
    case (x__h16723)
      3'd0: ras_1_first = n__read__h16843;
      3'd1: ras_1_first = n__read__h16845;
      3'd2: ras_1_first = n__read__h16847;
      3'd3: ras_1_first = n__read__h16849;
      3'd4: ras_1_first = n__read__h16851;
      3'd5: ras_1_first = n__read__h16853;
      3'd6: ras_1_first = n__read__h16855;
      3'd7: ras_1_first = n__read__h16857;
    endcase
  end
  ...
  assign stack_0_lat_0$whas =
	     EN_ras_0_popPush && v__h15844 == 3'd0 &&
	     ras_0_popPush_pushAddr[64] ;
  assign stack_0_lat_1$whas =
	     EN_ras_1_popPush && v__h17577 == 3'd0 &&
	     ras_1_popPush_pushAddr[64] ;
  assign stack_1_lat_0$whas =
	     EN_ras_0_popPush && v__h15844 == 3'd1 &&
	     ras_0_popPush_pushAddr[64] ;
  assign stack_1_lat_1$whas =
	     EN_ras_1_popPush && v__h17577 == 3'd1 &&
	     ras_1_popPush_pushAddr[64] ;
  assign stack_2_lat_0$whas =
	     EN_ras_0_popPush && v__h15844 == 3'd2 &&
	     ras_0_popPush_pushAddr[64] ;
  assign stack_2_lat_1$whas =
	     EN_ras_1_popPush && v__h17577 == 3'd2 &&
	     ras_1_popPush_pushAddr[64] ;
  assign stack_3_lat_0$whas =
	     EN_ras_0_popPush && v__h15844 == 3'd3 &&
	     ras_0_popPush_pushAddr[64] ;
  assign stack_3_lat_1$whas =
	     EN_ras_1_popPush && v__h17577 == 3'd3 &&
	     ras_1_popPush_pushAddr[64] ;
  assign stack_4_lat_0$whas =
	     EN_ras_0_popPush && v__h15844 == 3'd4 &&
	     ras_0_popPush_pushAddr[64] ;
  assign stack_4_lat_1$whas =
	     EN_ras_1_popPush && v__h17577 == 3'd4 &&
	     ras_1_popPush_pushAddr[64] ;
  assign stack_5_lat_0$whas =
	     EN_ras_0_popPush && v__h15844 == 3'd5 &&
	     ras_0_popPush_pushAddr[64] ;
  assign stack_5_lat_1$whas =
	     EN_ras_1_popPush && v__h17577 == 3'd5 &&
	     ras_1_popPush_pushAddr[64] ;
  assign stack_6_lat_0$whas =
	     EN_ras_0_popPush && v__h15844 == 3'd6 &&
	     ras_0_popPush_pushAddr[64] ;
  assign stack_6_lat_1$whas =
	     EN_ras_1_popPush && v__h17577 == 3'd6 &&
	     ras_1_popPush_pushAddr[64] ;
  assign stack_7_lat_0$whas =
	     EN_ras_0_popPush && v__h15844 == 3'd7 &&
	     ras_0_popPush_pushAddr[64] ;
  assign stack_7_lat_1$whas =
	     EN_ras_1_popPush && v__h17577 == 3'd7 &&
	     ras_1_popPush_pushAddr[64] ;
  ...
  assign head_rl$D_IN =
	     EN_ras_1_popPush ?
	       upd__h13212 :
	       IF_head_lat_0_whas__11_THEN_IF_head_lat_0_whas_ETC___d115 ;
  ...
  assign stack_0_rl$D_IN =
	     stack_0_lat_1$whas ?
	       ...
	       IF_stack_0_lat_0_whas_THEN_IF_stack_0_lat_0_wh_ETC___d11 ;
  ...
  // remaining internal signals
  assign IF_head_lat_0_whas__11_THEN_IF_head_lat_0_whas_ETC___d115 =
	     EN_ras_0_popPush ? upd__h13239 : head_rl ;
  assign IF_stack_0_lat_0_whas_THEN_IF_stack_0_lat_0_wh_ETC___d11 =
	     stack_0_lat_0$whas ? ras_0_popPush_pushAddr[63:0] : stack_0_rl ;
  assign IF_stack_1_lat_0_whas__0_THEN_IF_stack_1_lat_0_ETC___d24 =
	     stack_1_lat_0$whas ? ras_0_popPush_pushAddr[63:0] : stack_1_rl ;
  assign IF_stack_2_lat_0_whas__3_THEN_IF_stack_2_lat_0_ETC___d37 =
	     stack_2_lat_0$whas ? ras_0_popPush_pushAddr[63:0] : stack_2_rl ;
  assign IF_stack_3_lat_0_whas__6_THEN_IF_stack_3_lat_0_ETC___d50 =
	     stack_3_lat_0$whas ? ras_0_popPush_pushAddr[63:0] : stack_3_rl ;
  assign IF_stack_4_lat_0_whas__9_THEN_IF_stack_4_lat_0_ETC___d63 =
	     stack_4_lat_0$whas ? ras_0_popPush_pushAddr[63:0] : stack_4_rl ;
  assign IF_stack_5_lat_0_whas__2_THEN_IF_stack_5_lat_0_ETC___d76 =
	     stack_5_lat_0$whas ? ras_0_popPush_pushAddr[63:0] : stack_5_rl ;
  assign IF_stack_6_lat_0_whas__5_THEN_IF_stack_6_lat_0_ETC___d89 =
	     stack_6_lat_0$whas ? ras_0_popPush_pushAddr[63:0] : stack_6_rl ;
  assign IF_stack_7_lat_0_whas__8_THEN_IF_stack_7_lat_0_ETC___d102 =
	     stack_7_lat_0$whas ? ras_0_popPush_pushAddr[63:0] : stack_7_rl ;
  assign _theResult____h15795 =
	     ras_0_popPush_pop ? h___1__h15874 : h__h15794 ;
  assign _theResult____h17528 =
	     ras_1_popPush_pop ? h___1__h17604 : x__h16723 ;
  assign h___1__h15874 = h__h15794 - 3'd1 ;
  assign h___1__h17604 = x__h16723 - 3'd1 ;
  assign h__h15794 =
