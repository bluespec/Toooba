...
//
// On Tue Aug 31 12:59:20 EDT 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkUART(CLK,
  ...
  // register rg_dll
  assign rg_dll$D_IN = WILL_FIRE_RL_rl_reset ? 8'd0 : x__h4261[7:0] ;
  assign rg_dll$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__50_BITS_92_T_ETC___d258 ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  // register rg_dlm
  assign rg_dlm$D_IN = WILL_FIRE_RL_rl_reset ? 8'd0 : x__h4261[7:0] ;
  assign rg_dlm$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__50_BITS_92_T_ETC___d267 ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  // register rg_fcr
  assign rg_fcr$D_IN = WILL_FIRE_RL_rl_reset ? 8'd0 : x__h4261[7:0] ;
  assign rg_fcr$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__50_BITS_92_T_ETC___d271 ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  // register rg_ier
  assign rg_ier$D_IN = WILL_FIRE_RL_rl_reset ? 8'd0 : x__h4261[7:0] ;
  assign rg_ier$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__50_BITS_92_T_ETC___d263 ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  // register rg_lcr
  assign rg_lcr$D_IN = WILL_FIRE_RL_rl_reset ? 8'd0 : x__h4261[7:0] ;
  assign rg_lcr$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__50_BITS_92_T_ETC___d275 ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  case (1'b1)
    ...
    WILL_FIRE_RL_rl_receive: rg_lsr$D_IN = new_lsr__h5861;
  ...
  // register rg_mcr
  assign rg_mcr$D_IN = WILL_FIRE_RL_rl_reset ? 8'd0 : x__h4261[7:0] ;
  assign rg_mcr$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__50_BITS_92_T_ETC___d279 ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  // register rg_scr
  assign rg_scr$D_IN = WILL_FIRE_RL_rl_reset ? 8'd0 : x__h4261[7:0] ;
  assign rg_scr$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__50_BITS_92_T_ETC___d283 ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  // register rg_thr
  assign rg_thr$D_IN = x__h4261[7:0] ;
  assign rg_thr$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__50_BITS_92_T_ETC___d192 ;
  ...
  // submodule f_to_console
  assign f_to_console$D_IN = x__h4261[7:0] ;
  ...
  assign slave_xactor_f_wr_resp$D_IN =
	     { slave_xactor_f_wr_addr$D_OUT[96:93], v__h3657 } ;
  ...
  assign new_lsr__h5861 = { rg_lsr[7:1], 1'd1 } ;
  ...
  assign rdr_rresp__h3276 =
	     (slave_xactor_f_rd_addr_first__4_BITS_92_TO_29__ETC___d17 ||
	      !slave_xactor_f_rd_addr_first__4_BITS_92_TO_29__ETC___d19) ?
	       2'b11 :
	       y_avValue_fst__h3240 ;
  assign result__h4279 = { 56'd0, slave_xactor_f_wr_data$D_OUT[16:9] } ;
  assign result__h4309 = { 56'd0, slave_xactor_f_wr_data$D_OUT[24:17] } ;
  assign result__h4336 = { 56'd0, slave_xactor_f_wr_data$D_OUT[32:25] } ;
  assign result__h4363 = { 56'd0, slave_xactor_f_wr_data$D_OUT[40:33] } ;
  assign result__h4390 = { 56'd0, slave_xactor_f_wr_data$D_OUT[48:41] } ;
  assign result__h4417 = { 56'd0, slave_xactor_f_wr_data$D_OUT[56:49] } ;
  assign result__h4444 = { 56'd0, slave_xactor_f_wr_data$D_OUT[64:57] } ;
  assign result__h4471 = { 56'd0, slave_xactor_f_wr_data$D_OUT[72:65] } ;
  assign result__h4498 = { 48'd0, slave_xactor_f_wr_data$D_OUT[24:9] } ;
  assign result__h4525 = { 48'd0, slave_xactor_f_wr_data$D_OUT[40:25] } ;
  assign result__h4552 = { 48'd0, slave_xactor_f_wr_data$D_OUT[56:41] } ;
  assign result__h4579 = { 48'd0, slave_xactor_f_wr_data$D_OUT[72:57] } ;
  assign result__h4606 = { 32'd0, slave_xactor_f_wr_data$D_OUT[40:9] } ;
  assign result__h4633 = { 32'd0, slave_xactor_f_wr_data$D_OUT[72:41] } ;
  ...
  assign v__h4017 =
	     (slave_xactor_f_wr_addr_first__50_BITS_92_TO_29_ETC___d156[63:5] ==
	      59'd0) ?
	       v__h4187 :
	       2'b11 ;
  assign v__h4187 = y_avValue_fst__h3212 ;
  assign x__h3303 =
	     (slave_xactor_f_rd_addr_first__4_BITS_92_TO_29__ETC___d17 ||
	      !slave_xactor_f_rd_addr_first__4_BITS_92_TO_29__ETC___d19 ||
	      slave_xactor_f_rd_addr_first__4_BITS_92_TO_29__ETC___d35[1:0] !=
  ...
  always@(slave_xactor_f_wr_data$D_OUT or
	  ...
	  result__h4417 or
	  result__h4552 or
	  result__h4444 or result__h4471 or result__h4579 or result__h4633)
  begin
    case (slave_xactor_f_wr_data$D_OUT[8:1])
      8'b00000001: x__h4261 = result__h4279;
      8'b00000010: x__h4261 = result__h4309;
      8'b00000011: x__h4261 = result__h4498;
      8'b00000100: x__h4261 = result__h4336;
      8'b00001000: x__h4261 = result__h4363;
      8'b00001100: x__h4261 = result__h4525;
      8'b00001111: x__h4261 = result__h4606;
      8'b00010000: x__h4261 = result__h4390;
      8'b00100000: x__h4261 = result__h4417;
      8'b00110000: x__h4261 = result__h4552;
      8'b01000000: x__h4261 = result__h4444;
      8'b10000000: x__h4261 = result__h4471;
      8'b11000000: x__h4261 = result__h4579;
      8'b11110000: x__h4261 = result__h4633;
      8'b11111111: x__h4261 = slave_xactor_f_wr_data$D_OUT[72:9];
      default: x__h4261 = 64'd0;
    endcase
  end
  ...
  begin
    ...
    v__h3402 = v__h3408 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_43___d144)
	$display("%0d: %m.rl_process_rd_req", v__h3402);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_43___d144)
	$write("            ");
    ...
    v__h5616 = v__h5622 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_43___d144)
	$display("%0d: %m.rl_process_wr_req", v__h5616);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_43___d144)
	$write("            ");
