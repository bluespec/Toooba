...
//
// On Tue Aug 31 13:19:29 EDT 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkSoC_Top(RST_N_dm_power_on_reset,
  ...
  assign corew$core_external_interrupt_sources_9_m_interrupt_req_set_not_clear =
	     1'd0 ;
  assign corew$cpu_dmem_master_arready = fabric$v_from_masters_1_arready ;
  assign corew$cpu_dmem_master_awready = fabric$v_from_masters_1_awready ;
  assign corew$cpu_dmem_master_bid = fabric$v_from_masters_1_bid ;
  assign corew$cpu_dmem_master_bresp = fabric$v_from_masters_1_bresp ;
  assign corew$cpu_dmem_master_bvalid = fabric$v_from_masters_1_bvalid ;
  assign corew$cpu_dmem_master_rdata = fabric$v_from_masters_1_rdata ;
  assign corew$cpu_dmem_master_rid = fabric$v_from_masters_1_rid ;
  assign corew$cpu_dmem_master_rlast = fabric$v_from_masters_1_rlast ;
  assign corew$cpu_dmem_master_rresp = fabric$v_from_masters_1_rresp ;
  assign corew$cpu_dmem_master_rvalid = fabric$v_from_masters_1_rvalid ;
  assign corew$cpu_dmem_master_wready = fabric$v_from_masters_1_wready ;
  assign corew$cpu_imem_master_arready = fabric$v_from_masters_0_arready ;
  assign corew$cpu_imem_master_awready = fabric$v_from_masters_0_awready ;
  assign corew$cpu_imem_master_bid = fabric$v_from_masters_0_bid ;
  assign corew$cpu_imem_master_bresp = fabric$v_from_masters_0_bresp ;
  assign corew$cpu_imem_master_bvalid = fabric$v_from_masters_0_bvalid ;
  assign corew$cpu_imem_master_rdata = fabric$v_from_masters_0_rdata ;
  assign corew$cpu_imem_master_rid = fabric$v_from_masters_0_rid ;
  assign corew$cpu_imem_master_rlast = fabric$v_from_masters_0_rlast ;
  ...
  assign fabric$v_from_masters_0_araddr = corew$cpu_imem_master_araddr ;
  assign fabric$v_from_masters_0_arburst = corew$cpu_imem_master_arburst ;
  assign fabric$v_from_masters_0_arcache = corew$cpu_imem_master_arcache ;
  assign fabric$v_from_masters_0_arid = corew$cpu_imem_master_arid ;
  assign fabric$v_from_masters_0_arlen = corew$cpu_imem_master_arlen ;
  assign fabric$v_from_masters_0_arlock = corew$cpu_imem_master_arlock ;
  assign fabric$v_from_masters_0_arprot = corew$cpu_imem_master_arprot ;
  assign fabric$v_from_masters_0_arqos = corew$cpu_imem_master_arqos ;
  assign fabric$v_from_masters_0_arregion = corew$cpu_imem_master_arregion ;
  assign fabric$v_from_masters_0_arsize = corew$cpu_imem_master_arsize ;
  assign fabric$v_from_masters_0_arvalid = corew$cpu_imem_master_arvalid ;
  assign fabric$v_from_masters_0_awaddr = corew$cpu_imem_master_awaddr ;
  assign fabric$v_from_masters_0_awburst = corew$cpu_imem_master_awburst ;
  assign fabric$v_from_masters_0_awcache = corew$cpu_imem_master_awcache ;
  assign fabric$v_from_masters_0_awid = corew$cpu_imem_master_awid ;
  assign fabric$v_from_masters_0_awlen = corew$cpu_imem_master_awlen ;
  assign fabric$v_from_masters_0_awlock = corew$cpu_imem_master_awlock ;
  assign fabric$v_from_masters_0_awprot = corew$cpu_imem_master_awprot ;
  assign fabric$v_from_masters_0_awqos = corew$cpu_imem_master_awqos ;
  assign fabric$v_from_masters_0_awregion = corew$cpu_imem_master_awregion ;
  assign fabric$v_from_masters_0_awsize = corew$cpu_imem_master_awsize ;
  assign fabric$v_from_masters_0_awvalid = corew$cpu_imem_master_awvalid ;
  ...
  assign fabric$v_from_masters_1_araddr = corew$cpu_dmem_master_araddr ;
  assign fabric$v_from_masters_1_arburst = corew$cpu_dmem_master_arburst ;
  assign fabric$v_from_masters_1_arcache = corew$cpu_dmem_master_arcache ;
  assign fabric$v_from_masters_1_arid = corew$cpu_dmem_master_arid ;
  assign fabric$v_from_masters_1_arlen = corew$cpu_dmem_master_arlen ;
  assign fabric$v_from_masters_1_arlock = corew$cpu_dmem_master_arlock ;
  assign fabric$v_from_masters_1_arprot = corew$cpu_dmem_master_arprot ;
  assign fabric$v_from_masters_1_arqos = corew$cpu_dmem_master_arqos ;
  assign fabric$v_from_masters_1_arregion = corew$cpu_dmem_master_arregion ;
  assign fabric$v_from_masters_1_arsize = corew$cpu_dmem_master_arsize ;
  assign fabric$v_from_masters_1_arvalid = corew$cpu_dmem_master_arvalid ;
  assign fabric$v_from_masters_1_awaddr = corew$cpu_dmem_master_awaddr ;
  assign fabric$v_from_masters_1_awburst = corew$cpu_dmem_master_awburst ;
  assign fabric$v_from_masters_1_awcache = corew$cpu_dmem_master_awcache ;
  assign fabric$v_from_masters_1_awid = corew$cpu_dmem_master_awid ;
  assign fabric$v_from_masters_1_awlen = corew$cpu_dmem_master_awlen ;
  assign fabric$v_from_masters_1_awlock = corew$cpu_dmem_master_awlock ;
  assign fabric$v_from_masters_1_awprot = corew$cpu_dmem_master_awprot ;
  assign fabric$v_from_masters_1_awqos = corew$cpu_dmem_master_awqos ;
  assign fabric$v_from_masters_1_awregion = corew$cpu_dmem_master_awregion ;
  assign fabric$v_from_masters_1_awsize = corew$cpu_dmem_master_awsize ;
  assign fabric$v_from_masters_1_awvalid = corew$cpu_dmem_master_awvalid ;
  ...
  begin
    ...
    v__h10663 = v__h10669 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_start_initial)
	$display("%0d: %m.rl_reset_start_initial ...", v__h10663);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h10895 = v__h10901 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete_initial)
	$display("%0d: %m.rl_reset_complete_initial", v__h10895);
  end
  // synopsys translate_on
endmodule  // mkSoC_Top
