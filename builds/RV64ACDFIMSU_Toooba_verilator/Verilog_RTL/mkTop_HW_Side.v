...
//
// On Wed Mar 25 15:46:40 GMT 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkTop_HW_Side(CLK,
  ...
  reg [63 : 0] y_avValue_fst__h638;
  reg [63 : 0] y_avValue_snd__h639;
  reg [7 : 0] v__h831;
  reg [63 : 0] tohost_addr__h647;
  reg [63 : 0] fromhost_addr__h648;
  ...
  // submodule soc_top
  assign soc_top$put_from_console_put = v__h831 ;
  ...
  assign soc_top$start_fromhost_addr = fromhost_addr__h648 ;
  assign soc_top$start_tohost_addr = tohost_addr__h647 ;
  ...
  begin
	...
	begin
	  y_avValue_fst__h638 = $imported_c_get_symbol_val("tohost");
	  #0;
	end
    tohost_addr__h647 = TASK_testplusargs___d17 ? y_avValue_fst__h638 : 64'd0;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_step0 && TASK_testplusargs___d17)
	begin
	  y_avValue_snd__h639 = $imported_c_get_symbol_val("fromhost");
	  #0;
	end
    fromhost_addr__h648 =
	TASK_testplusargs___d17 ? y_avValue_snd__h639 : 64'd0;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_step0)
	...
	begin
	  v__h831 = $imported_c_trygetchar(8'hAA);
	  #0;
	end
  end
  // synopsys translate_on
