...
//
// On Thu Jul 16 18:36:08 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkFpuMulDivDispToRegFifo(CLK,
  ...
  reg [29 : 0] CASE_enq_x_BITS_86_TO_84_0_enq_x_BITS_86_TO_57_ETC__q2,
	       CASE_m_m_row_0_BITS_74_TO_72_0_m_m_row_0_BITS__ETC__q1;
  wire [11 : 0] sb__h8439, upd__h1154;
  ...
  assign m_m_specBits_0_lat_1$wget =
	     sb__h8439 & specUpdate_correctSpeculation_mask ;

  // register m_m_row_0
  assign m_m_row_0$D_IN =
	     { CASE_enq_x_BITS_86_TO_84_0_enq_x_BITS_86_TO_57_ETC__q2,
	       enq_x[56:12] } ;
  assign m_m_row_0$EN = EN_enq ;

  // register m_m_specBits_0_rl
  assign m_m_specBits_0_rl$D_IN =
	     EN_specUpdate_correctSpeculation ? upd__h1154 : sb__h8439 ;
  ...
  // remaining internal signals
  assign sb__h8439 = EN_enq ? enq_x[11:0] : m_m_specBits_0_rl ;
  ...
  begin
    case (m_m_row_0[74:72])
	  ...
	  CASE_m_m_row_0_BITS_74_TO_72_0_m_m_row_0_BITS__ETC__q1 =
	      m_m_row_0[74:45];
      default: CASE_m_m_row_0_BITS_74_TO_72_0_m_m_row_0_BITS__ETC__q1 =
		   { 3'd5,
  ...
  begin
    case (enq_x[86:84])
	  ...
	  CASE_enq_x_BITS_86_TO_84_0_enq_x_BITS_86_TO_57_ETC__q2 =
	      enq_x[86:57];
      default: CASE_enq_x_BITS_86_TO_84_0_enq_x_BITS_86_TO_57_ETC__q2 =
		   { 3'd5,
		     27'bxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  };
    endcase
  end
