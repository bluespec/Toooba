...
module mkFpuMulDivDispToRegFifo(CLK,
  ...
  reg [20 : 0] CASE_enq_x_BITS_77_TO_75_0_enq_x_BITS_77_TO_57_ETC__q2,
	       CASE_m_m_row_0_BITS_65_TO_63_0_m_m_row_0_BITS__ETC__q4;
  reg [2 : 0] CASE_enq_x_BITS_60_TO_58_0_enq_x_BITS_60_TO_58_ETC__q1,
	      CASE_m_m_row_0_BITS_48_TO_46_0_m_m_row_0_BITS__ETC__q3;
  wire [11 : 0] IF_m_m_specBits_0_dummy2_0_read__15_AND_m_m_sp_ETC___d118,
		IF_m_m_specBits_0_lat_0_whas__0_THEN_m_m_specB_ETC___d13,
		sb__h9368,
		upd__h2322;
  wire _dand1m_m_valid_0_dummy2_0$EN_write, _dand1m_m_valid_0_lat_0$EN_wset;
  ...
  assign first =
	     { CASE_m_m_row_0_BITS_65_TO_63_0_m_m_row_0_BITS__ETC__q4,
	       m_m_row_0[44:0],
	       IF_m_m_specBits_0_dummy2_0_read__15_AND_m_m_sp_ETC___d118 } ;
  ...
  assign m_m_specBits_0_lat_1$wget =
	     sb__h9368 & specUpdate_correctSpeculation_mask ;

  // register m_m_row_0
  assign m_m_row_0$D_IN =
	     { CASE_enq_x_BITS_77_TO_75_0_enq_x_BITS_77_TO_57_ETC__q2,
	       enq_x[56:12] } ;
  ...
  // remaining internal signals
  assign IF_m_m_specBits_0_dummy2_0_read__15_AND_m_m_sp_ETC___d118 =
	     (m_m_specBits_0_dummy2_0$Q_OUT &&
	      m_m_specBits_0_dummy2_1$Q_OUT) ?
	       m_m_specBits_0_rl :
	       12'd0 ;
  ...
  assign _dand1m_m_valid_0_dummy2_0$EN_write =
	     EN_specUpdate_incorrectSpeculation &&
	     (specUpdate_incorrectSpeculation_kill_all ||
	      IF_m_m_specBits_0_dummy2_0_read__15_AND_m_m_sp_ETC___d118[specUpdate_incorrectSpeculation_kill_tag]) ;
  ...
  begin
    case (enq_x[60:58])
	  ...
	  CASE_enq_x_BITS_60_TO_58_0_enq_x_BITS_60_TO_58_ETC__q1 =
	      enq_x[60:58];
      default: CASE_enq_x_BITS_60_TO_58_0_enq_x_BITS_60_TO_58_ETC__q1 = 3'd7;
    endcase
  end
  always@(enq_x or CASE_enq_x_BITS_60_TO_58_0_enq_x_BITS_60_TO_58_ETC__q1)
  begin
    case (enq_x[77:75])
      3'd0, 3'd1, 3'd2, 3'd3:
	  CASE_enq_x_BITS_77_TO_75_0_enq_x_BITS_77_TO_57_ETC__q2 =
	  ...
	  CASE_enq_x_BITS_77_TO_75_0_enq_x_BITS_77_TO_57_ETC__q2 =
		...
		CASE_enq_x_BITS_60_TO_58_0_enq_x_BITS_60_TO_58_ETC__q1,
		enq_x[57] };
      default: CASE_enq_x_BITS_77_TO_75_0_enq_x_BITS_77_TO_57_ETC__q2 =
		   21'd1485482;
    endcase
  end
  always@(m_m_row_0)
  begin
    case (m_m_row_0[48:46])
	  ...
	  CASE_m_m_row_0_BITS_48_TO_46_0_m_m_row_0_BITS__ETC__q3 =
	      m_m_row_0[48:46];
      default: CASE_m_m_row_0_BITS_48_TO_46_0_m_m_row_0_BITS__ETC__q3 = 3'd7;
    endcase
  end
  always@(m_m_row_0 or CASE_m_m_row_0_BITS_48_TO_46_0_m_m_row_0_BITS__ETC__q3)
  begin
    case (m_m_row_0[65:63])
	  ...
	  CASE_m_m_row_0_BITS_65_TO_63_0_m_m_row_0_BITS__ETC__q4 =
		...
		CASE_m_m_row_0_BITS_48_TO_46_0_m_m_row_0_BITS__ETC__q3,
		m_m_row_0[45] };
      default: CASE_m_m_row_0_BITS_65_TO_63_0_m_m_row_0_BITS__ETC__q4 =
		   21'd1485482;
    endcase
  end
