...
//
// On Mon Jul 13 18:44:00 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkRobRowSynth(CLK,
  ...
  wire [196 : 0] m_scr_22_BIT_5_23_CONCAT_IF_m_scr_22_BIT_5_23__ETC___d1111;
  wire [162 : 0] IF_m_ppc_vaddr_csrData_rl_64_BITS_130_TO_129_6_ETC___d1109;
  ...
  wire [11 : 0] sb__h17805, upd__h9919;
  ...
  wire IF_m_ldKilled_lat_1_whas__18_THEN_m_ldKilled_l_ETC___d627,
       ...
       setExecuted_doFinishFpuMulDiv_0_set_cause_BIT__ETC___d1330;
  ...
  assign read_deq =
	     { m_pc_rl,
	       ...
	       m_iType,
	       m_rg_dst_reg,
	       m_scr_22_BIT_5_23_CONCAT_IF_m_scr_22_BIT_5_23__ETC___d1111 } ;
  ...
  assign m_spec_bits_rl$D_IN =
	     EN_correctSpeculation ? upd__h9919 : sb__h17805 ;
  ...
  assign IF_m_ppc_vaddr_csrData_rl_64_BITS_130_TO_129_6_ETC___d1109 =
  ...
  assign IF_m_trap_lat_3_whas__7_THEN_m_trap_lat_3_wget_ETC___d90 =
	     EN_write_enq ?
		  ...
		  IF_m_trap_lat_1_whas__3_THEN_m_trap_lat_1_wget_ETC___d88) ;
  assign m_scr_22_BIT_5_23_CONCAT_IF_m_scr_22_BIT_5_23__ETC___d1111 =
	     { m_scr[5],
  ...
  assign sb__h17805 = EN_write_enq ? write_enq_x[11:0] : m_spec_bits_rl ;
  assign setExecuted_doFinishFpuMulDiv_0_set_cause_BIT__ETC___d1330 =
	     setExecuted_doFinishFpuMulDiv_0_set_cause[5] &&
	     (m_trap_lat_1$whas ?
		!m_trap_lat_1$wget[13] :
		IF_m_trap_lat_0_whas__6_THEN_NOT_m_trap_lat_0__ETC___d42) ;
  assign upd__h9919 = sb__h17805 & correctSpeculation_mask ;
