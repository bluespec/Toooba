...
module mkCoreW(RST_N_dm_power_on_reset,
  ...
  // action method start
  assign RDY_start = tv_encode$RDY_reset && proc$RDY_start ;
  assign CAN_FIRE_start = tv_encode$RDY_reset && proc$RDY_start ;
