...
module mkCoreW(CLK,
  ...
  wire proc$EN_hart0_csr_mem_server_request_put,
       ...
       proc$RDY_hart0_server_run_halt_request_put,
       proc$RDY_hart0_server_run_halt_response_get,
       proc$RDY_start,
       proc$RDY_trace_data_out_get,
       proc$debug_external_interrupt_req_set_not_clear,
       proc$hart0_server_run_halt_request_put,
       proc$hart0_server_run_halt_response_get,
  ...
  wire fabric_2x3_RDY_reset_AND_proc_RDY_hart0_server_ETC___d8;
  ...
  mkProc proc(.CLK(CLK),
	      ...
	      .RDY_hart0_server_run_halt_request_put(proc$RDY_hart0_server_run_halt_request_put),
	      .hart0_server_run_halt_response_get(proc$hart0_server_run_halt_response_get),
	      .RDY_hart0_server_run_halt_response_get(proc$RDY_hart0_server_run_halt_response_get),
  ...
  assign CAN_FIRE_RL_rl_cpu_hart0_reset_from_soc_start =
	     plic$RDY_server_reset_request_put &&
	     fabric_2x3_RDY_reset_AND_proc_RDY_hart0_server_ETC___d8 ;
  ...
  assign proc$hart0_server_run_halt_request_put =
	     debug_module$hart0_client_run_halt_request_get ;
  ...
  assign proc$EN_hart0_server_run_halt_request_put =
	     CAN_FIRE_RL_ClientServerRequest ;
  ...
  // remaining internal signals
  assign fabric_2x3_RDY_reset_AND_proc_RDY_hart0_server_ETC___d8 =
	     fabric_2x3$RDY_reset &&
	     proc$RDY_hart0_server_reset_request_put &&
	     f_reset_reqs$EMPTY_N &&
	     f_reset_requestor$FULL_N ;
