...
//
// On Wed Jun 17 12:42:20 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkIBankWrapper(CLK,
  ...
  wire [56 : 0] m_cRqMshr$pipelineResp_setStateSlot_slot,
  ...
  reg [31 : 0] CASE_m_cRqMshrpipelineResp_getRq_BITS_5_TO_2__ETC__q37,
	       CASE_sel1069_0_m_pipelinefirst_BITS_31_TO_0_1_ETC__q36;
  ...
  wire [58 : 0] IF_m_cRqMshr_pipelineResp_searchEndOfChain_m_c_ETC___d602,
  ...
  wire IF_IF_m_fromPQ_deqReq_lat_1_whas__30_THEN_m_fr_ETC___d360,
       ...
       m_pipeline_first__47_BITS_574_TO_522_60_EQ_m_c_ETC___d562,
  ...
  assign m_pipeline_first__47_BITS_574_TO_522_60_EQ_m_c_ETC___d562 =
	     m_pipeline$first[574:522] ==
	     m_cRqMshr$pipelineResp_getRq[63:11] ;
  ...
  assign sel__h51069 = m_cRqMshr$pipelineResp_getRq[5:2] + 4'd1 ;
  assign v__h10212 =
	     IF_m_rsToPQ_enqReq_lat_1_whas__1_THEN_m_rsToPQ_ETC___d40 ?
	       v__h10363 :
	       m_rsToPQ_enqP ;
  ...
  always@(sel__h51069 or m_pipeline$first)
  begin
    case (sel__h51069)
      4'd0:
	  CASE_sel1069_0_m_pipelinefirst_BITS_31_TO_0_1_ETC__q36 =
