...
//
// On Mon Jul  6 19:25:52 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkProc(CLK,
  ...
  reg [63 : 0] CASE_llc_axi4_adapter_rg_wr_req_beat_BIT_0_0_l_ETC__q1,
	       ...
	       CASE_x00766_0_IF_CAN_FIRE_RL_srcPropose_THEN_p_ETC__q14,
	       CASE_x22868_0_IF_CAN_FIRE_RL_srcPropose_2_THEN_ETC__q15,
  ...
  reg [7 : 0] v_wstrb__h217506, wflit_wstrb__h17688;
  reg [5 : 0] IF_mmioPlatform_reqFunc_04_BITS_5_TO_4_05_EQ_0_ETC___d846;
  reg [2 : 0] x__h100966;
  reg [1 : 0] CASE_x00766_0_IF_CAN_FIRE_RL_srcPropose_THEN_p_ETC__q12,
  ...
  reg CASE_mmioPlatform_reqFunc_BITS_5_TO_4_0_core_0_ETC__q10,
      ...
      CASE_x00766_0_IF_CAN_FIRE_RL_srcPropose_THEN_p_ETC__q11,
      CASE_x22868_0_IF_CAN_FIRE_RL_srcPropose_2_THEN_ETC__q17,
      CASE_x22868_0_IF_CAN_FIRE_RL_srcPropose_2_THEN_ETC__q18,
      CASE_x22868_0_IF_CAN_FIRE_RL_srcPropose_2_THEN_ETC__q19,
      CASE_x22868_0_IF_CAN_FIRE_RL_srcPropose_2_THEN_ETC__q26,
  ...
  wire [4 : 0] SEL_ARR_IF_propDstData_0_lat_0_whas__429_THEN__ETC___d1534,
	       ...
	       y__h15300,
	       y__h15312;
  wire [3 : 0] b__h193265, b__h2174, mmioPlatform_reqAmofunc__h88313;
  ...
  // inlined wires
  assign mmioPlatform_toHostQ_enqReq_lat_0$wget = { 1'd1, x__h73624 } ;
  ...
  assign llc_axi4_adapter_master_xactor_shim_awff_rv$port0__write_1 =
	     { 6'd32, v_awaddr__h217034, 29'd15532032 } ;
  ...
  assign llc_axi4_adapter_master_xactor_shim_arff_rv$port0__write_1 =
	     { 6'd32, line_addr__h193465, 29'd15532032 } ;
  ...
  assign llc_axi4_adapter_rg_wr_req_beat$D_IN =
	     (llc_axi4_adapter_rg_wr_req_beat == 3'd7) ? 3'd0 : x__h217392 ;
  ...
  assign core_0$tlbToMem_respLd_enq_x =
	     { ld_data__h188191, llc$dma_respLd_first[3] } ;
  ...
  module_amoExec instance_amoExec_2(.amoExec_amo_inst(mmioPlatform_reqFunc_04_BITS_3_TO_0_44_CONCAT__ETC___d912),
				    .amoExec_wordIdx({ 1'd0,
						       IF_mmioPlatform_reqBE_07_BITS_7_TO_0_01_EQ_0_0_ETC___d907[4] &&
						       !IF_mmioPlatform_reqBE_07_BITS_7_TO_0_01_EQ_0_0_ETC___d907[0] }),
				    .amoExec_current({ 65'd0, x__h79171 }),
				    .amoExec_inpt({ 65'd0,
						    IF_mmioPlatform_reqBE_07_BITS_7_TO_0_01_EQ_0_0_ETC___d920 }),
				    .amoExec(amoExec___d1131));
  module_amoExec instance_amoExec_4(.amoExec_amo_inst({ mmioPlatform_reqAmofunc__h88313,
							((mmioPlatform_reqBE[0] ?
							    5'd1 :
							    5'd0) +
  ...
  assign _theResult____h13492 =
	     (whichHalf___1__h15055 ||
	      mmio_axi4_adapter_f_reqs_from_core$D_OUT[144:137] == 8'd0) ?
	       whichHalf___1__h15055 :
	       mmio_axi4_adapter_rg_wr_req_beat ;
  assign addr1__h90543 = { mmioPlatform_curReq[63:3], 3'b0 } ;
  ...
  assign llc_mem_server_axi4_slave_xactor_shim_arff_rv__ETC___d2039 =
	     line_addr__h150186 == llc_mem_server_rg_cacheline_cache_addr ;
  assign llc_mem_server_axi4_slave_xactor_shim_awff_rv__ETC___d1938 =
	     line_addr__h140075 == llc_mem_server_rg_cacheline_cache_addr ;
  ...
  assign mmioPlatform_mtip_0_00_OR_NOT_mmioPlatform_mti_ETC___d762 =
	     ...
	     !core_0_mmioToPlatform_cRq_first__23_BITS_214_T_ETC___d525 &&
	     core_0_mmioToPlatform_cRq_first__23_BITS_214_T_ETC___d527 ;
  assign mmioPlatform_reqAmofunc__h88313 = mmioPlatform_reqAmofunc ;
  ...
  assign v_awaddr__h217034 = { llc$to_mem_toM_first[643:586], 6'h0 } ;
  ...
  assign x__h194318 = llc_axi4_adapter_rg_rd_rsp_beat + 3'd1 ;
  assign x__h217392 = llc_axi4_adapter_rg_wr_req_beat + 3'd1 ;
  assign x__h48542 =
	     { IF_IF_mmioPlatform_reqBE_07_BITS_7_TO_0_01_EQ__ETC___d949,
  ...
  assign x__h73624 =
	     (mmioPlatform_reqFunc[5:4] != 2'd0 &&
	      ...
	      mmioPlatform_reqFunc[5:4] != 2'd2) ?
	       ...
	       x__h64500 ;
  assign x__h79171 = mmioPlatform_fromHostQ_data_0 ;
  ...
  begin
    case (llc$dma_respLd_first[2:0])
      3'd0: ld_data__h188191 = llc$dma_respLd_first[68:5];
      3'd1: ld_data__h188191 = llc$dma_respLd_first[132:69];
      3'd2: ld_data__h188191 = llc$dma_respLd_first[196:133];
      3'd3: ld_data__h188191 = llc$dma_respLd_first[260:197];
      3'd4: ld_data__h188191 = llc$dma_respLd_first[324:261];
      3'd5: ld_data__h188191 = llc$dma_respLd_first[388:325];
      3'd6: ld_data__h188191 = llc$dma_respLd_first[452:389];
      3'd7: ld_data__h188191 = llc$dma_respLd_first[516:453];
    endcase
  end
  ...
  begin
    case (llc_axi4_adapter_rg_wr_req_beat)
      3'd0: v_wstrb__h217506 = llc$to_mem_toM_first[523:516];
      3'd1: v_wstrb__h217506 = llc$to_mem_toM_first[531:524];
      3'd2: v_wstrb__h217506 = llc$to_mem_toM_first[539:532];
      3'd3: v_wstrb__h217506 = llc$to_mem_toM_first[547:540];
      3'd4: v_wstrb__h217506 = llc$to_mem_toM_first[555:548];
      3'd5: v_wstrb__h217506 = llc$to_mem_toM_first[563:556];
      3'd6: v_wstrb__h217506 = llc$to_mem_toM_first[571:564];
      3'd7: v_wstrb__h217506 = llc$to_mem_toM_first[579:572];
    endcase
  end
  ...
  begin
    case (llc_axi4_adapter_rg_wr_req_beat[2:1])
      2'd0: v_wuser__h217508 = llc$to_mem_toM_first[512];
      2'd1: v_wuser__h217508 = llc$to_mem_toM_first[513];
      2'd2: v_wuser__h217508 = llc$to_mem_toM_first[514];
      2'd3: v_wuser__h217508 = llc$to_mem_toM_first[515];
    endcase
  end
  ...
  begin
    case (llc_mem_server_axi4_slave_xactor_shim_arff_rv$port1__read[34:32])
      3'd0: dword__h150369 = llc_mem_server_rg_cacheline_cache_data[63:0];
      3'd1: dword__h150369 = llc_mem_server_rg_cacheline_cache_data[127:64];
      3'd2: dword__h150369 = llc_mem_server_rg_cacheline_cache_data[191:128];
      3'd3: dword__h150369 = llc_mem_server_rg_cacheline_cache_data[255:192];
      3'd4: dword__h150369 = llc_mem_server_rg_cacheline_cache_data[319:256];
      3'd5: dword__h150369 = llc_mem_server_rg_cacheline_cache_data[383:320];
      3'd6: dword__h150369 = llc_mem_server_rg_cacheline_cache_data[447:384];
      3'd7: dword__h150369 = llc_mem_server_rg_cacheline_cache_data[511:448];
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_tohost && mmioPlatform_toHostQ_data_0 != 64'd0 &&
	  mmioPlatform_toHostQ_data_0[63:1] != 63'd0)
	$display("FAIL %0d", failed_testnum__h225871);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_tohost && mmioPlatform_toHostQ_data_0 != 64'd0)
	$finish(32'd0);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h217140 = v__h217146 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_llc_axi4_adapter_rl_handle_write_req &&
	  llc_axi4_adapter_rg_wr_req_beat == 3'd0 &&
	  llc_axi4_adapter_ctr_wr_rsps_pending_crg == 4'd15)
	$display("%0d: ERROR: CreditCounter: overflow", v__h217140);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_llc_axi4_adapter_rl_handle_write_req &&
	  llc_axi4_adapter_rg_wr_req_beat == 3'd0 &&
	  llc_axi4_adapter_ctr_wr_rsps_pending_crg == 4'd15)
