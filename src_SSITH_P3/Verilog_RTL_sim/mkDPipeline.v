...
//
// On Fri Jul 10 20:58:15 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkDPipeline(CLK,
  ...
  // inlined wires
  wire [1063 : 0] m_pipe_enq2Mat_lat_0$wget, m_pipe_enq2Mat_lat_2$wget;
		...
		m_pipe_mat2Out_rl[647:646] == 2'd0) ?
		 ...
		 ((m_pipe_mat2Out_rl[648] &&
		   m_pipe_mat2Out_rl[647:646] == 2'd1) ?
		    { 3'd2, m_pipe_mat2Out_rl[580:579] } :
		    5'd18),
  ...
  begin
	...
	m_pipe_enq2Mat_rl <= `BSV_ASSIGNMENT_DELAY
	    1064';
