...
//
// On Fri Jun  5 17:46:19 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkCoreW(RST_N_dm_power_on_reset,
  ...
  wire [98 : 0] tagController_tmp_shimSlave_arff_rv$port0__write_1,
		...
		ug_uncached_mem_shim_master_u_ar_peekWire$wget,
		ug_uncached_mem_shim_master_u_aw_peekWire$wget;
  ...
  wire [72 : 0] tagController_tmp_ug_master_u_r_putWire$wget,
		tmp2_r_buffer_enqw$wget,
		ug_uncached_mem_shim_master_u_r_putWire$wget;
  ...
  wire [7 : 0] tagController_tmp_shimSlave_bff_rv$port0__write_1,
	       ...
	       ug_uncached_mem_shim_master_u_b_putWire$wget;
  wire [6 : 0] tmp2_b_buffer_enqw$wget;
  wire [5 : 0] msNoSynth_0_b_buffer_enqw$wget,
  ...
  wire flitToSink_0$whas,
       ...
       tmp0_ar_dwReady$whas,
       tmp0_aw_dwReady$whas,
       tmp0_b_buffer_enqw$whas,
       tmp0_r_buffer_enqw$whas,
       tmp0_w_dwReady$whas,
       ug_uncached_mem_shim_master_u_ar_dropWire$whas,
       ug_uncached_mem_shim_master_u_aw_dropWire$whas,
       ug_uncached_mem_shim_master_u_b_putWire$whas,
       ug_uncached_mem_shim_master_u_r_putWire$whas,
       ug_uncached_mem_shim_master_u_w_dropWire$whas;
  ...
  wire [5 : 0] tmp0_b_buffer_ff$D_IN, tmp0_b_buffer_ff$D_OUT;
  ...
  wire [71 : 0] tmp0_r_buffer_ff$D_IN, tmp0_r_buffer_ff$D_OUT;
  ...
  // ports of submodule tmp2_b_buffer_ff
  wire [6 : 0] tmp2_b_buffer_ff$D_IN, tmp2_b_buffer_ff$D_OUT;
  wire tmp2_b_buffer_ff$CLR,
       tmp2_b_buffer_ff$DEQ,
       tmp2_b_buffer_ff$EMPTY_N,
       tmp2_b_buffer_ff$ENQ,
       tmp2_b_buffer_ff$FULL_N;

  // ports of submodule tmp2_b_buffer_firstValid
  wire tmp2_b_buffer_firstValid$D_IN,
       tmp2_b_buffer_firstValid$EN,
       tmp2_b_buffer_firstValid$Q_OUT;

  // ports of submodule tmp2_r_buffer_ff
  wire [72 : 0] tmp2_r_buffer_ff$D_IN, tmp2_r_buffer_ff$D_OUT;
  wire tmp2_r_buffer_ff$CLR,
       tmp2_r_buffer_ff$DEQ,
       tmp2_r_buffer_ff$EMPTY_N,
       tmp2_r_buffer_ff$ENQ,
       tmp2_r_buffer_ff$FULL_N;

  // ports of submodule tmp2_r_buffer_firstValid
  wire tmp2_r_buffer_firstValid$D_IN,
       tmp2_r_buffer_firstValid$EN,
       tmp2_r_buffer_firstValid$Q_OUT;
  ...
  wire CAN_FIRE_RL_ClientServerRequest,
       ...
       CAN_FIRE_RL_Prelude_inst_changeSpecialWires_1_mkConnectionGetPut,
       ...
       CAN_FIRE_RL_Prelude_inst_changeSpecialWires_4_mkConnectionGetPut,
       CAN_FIRE_RL_Prelude_inst_changeSpecialWires_mkConnectionGetPut,
       ...
       CAN_FIRE_RL_tmp2_ar_forwardReady,
       CAN_FIRE_RL_tmp2_aw_forwardReady,
       CAN_FIRE_RL_tmp2_b_buffer_dequeue,
       CAN_FIRE_RL_tmp2_b_buffer_enqueue,
       CAN_FIRE_RL_tmp2_b_dropFlit,
       CAN_FIRE_RL_tmp2_b_forwardFlit,
       CAN_FIRE_RL_tmp2_r_buffer_dequeue,
       CAN_FIRE_RL_tmp2_r_buffer_enqueue,
       CAN_FIRE_RL_tmp2_r_dropFlit,
       CAN_FIRE_RL_tmp2_r_forwardFlit,
       CAN_FIRE_RL_tmp2_w_forwardReady,
       CAN_FIRE_RL_ug_uncached_mem_shim_master_u_ar_doDrop,
       CAN_FIRE_RL_ug_uncached_mem_shim_master_u_ar_setPeek,
       CAN_FIRE_RL_ug_uncached_mem_shim_master_u_ar_warnDoDrop,
       CAN_FIRE_RL_ug_uncached_mem_shim_master_u_aw_doDrop,
       CAN_FIRE_RL_ug_uncached_mem_shim_master_u_aw_setPeek,
       CAN_FIRE_RL_ug_uncached_mem_shim_master_u_aw_warnDoDrop,
       CAN_FIRE_RL_ug_uncached_mem_shim_master_u_b_doPut,
       CAN_FIRE_RL_ug_uncached_mem_shim_master_u_b_warnDoPut,
       CAN_FIRE_RL_ug_uncached_mem_shim_master_u_r_doPut,
       CAN_FIRE_RL_ug_uncached_mem_shim_master_u_r_warnDoPut,
       CAN_FIRE_RL_ug_uncached_mem_shim_master_u_w_doDrop,
       CAN_FIRE_RL_ug_uncached_mem_shim_master_u_w_setPeek,
       CAN_FIRE_RL_ug_uncached_mem_shim_master_u_w_warnDoDrop,
       ...
       WILL_FIRE_RL_Prelude_inst_changeSpecialWires_1_mkConnectionGetPut,
       ...
       WILL_FIRE_RL_Prelude_inst_changeSpecialWires_4_mkConnectionGetPut,
       WILL_FIRE_RL_Prelude_inst_changeSpecialWires_mkConnectionGetPut,
       ...
       WILL_FIRE_RL_tmp2_ar_forwardReady,
       WILL_FIRE_RL_tmp2_aw_forwardReady,
       WILL_FIRE_RL_tmp2_b_buffer_dequeue,
       WILL_FIRE_RL_tmp2_b_buffer_enqueue,
       WILL_FIRE_RL_tmp2_b_dropFlit,
       WILL_FIRE_RL_tmp2_b_forwardFlit,
       WILL_FIRE_RL_tmp2_r_buffer_dequeue,
       WILL_FIRE_RL_tmp2_r_buffer_enqueue,
       WILL_FIRE_RL_tmp2_r_dropFlit,
       WILL_FIRE_RL_tmp2_r_forwardFlit,
       WILL_FIRE_RL_tmp2_w_forwardReady,
       WILL_FIRE_RL_ug_uncached_mem_shim_master_u_ar_doDrop,
       WILL_FIRE_RL_ug_uncached_mem_shim_master_u_ar_setPeek,
       WILL_FIRE_RL_ug_uncached_mem_shim_master_u_ar_warnDoDrop,
       WILL_FIRE_RL_ug_uncached_mem_shim_master_u_aw_doDrop,
       WILL_FIRE_RL_ug_uncached_mem_shim_master_u_aw_setPeek,
       WILL_FIRE_RL_ug_uncached_mem_shim_master_u_aw_warnDoDrop,
       WILL_FIRE_RL_ug_uncached_mem_shim_master_u_b_doPut,
       WILL_FIRE_RL_ug_uncached_mem_shim_master_u_b_warnDoPut,
       WILL_FIRE_RL_ug_uncached_mem_shim_master_u_r_doPut,
       WILL_FIRE_RL_ug_uncached_mem_shim_master_u_r_warnDoPut,
       WILL_FIRE_RL_ug_uncached_mem_shim_master_u_w_doDrop,
       WILL_FIRE_RL_ug_uncached_mem_shim_master_u_w_setPeek,
       WILL_FIRE_RL_ug_uncached_mem_shim_master_u_w_warnDoDrop,
  ...
  wire [63 : 0] araddr__h15532,
		...
		x_rdata__h25037;
  wire [39 : 0] x__h10832;
  wire [8 : 0] x_port1__read__h73054, x_port1__read__h75518;
  wire [7 : 0] arlen__h15533, v_arlen__h15550;
  wire [5 : 0] v_arid__h15548;
  wire [4 : 0] a_awid__h38608,
	       a_awid__h41374,
	       fatReq_arid__h72495,
	       fatReq_arid__h74960;
  wire [3 : 0] _0_CONCAT_tagController_tmp_tagCon_memory_reque_ETC___d245,
	       arcache__h15537,
	       x__h10875,
	       x__h12609,
	       x__h12621,
	       ...
	       y__h12670,
	       y__h12682;
  wire [2 : 0] aw_awsize_val__h12539, v_arsize_val__h15595;
  wire [1 : 0] IF_IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ETC___d1221,
	       IF_IF_merged_1_flitLeft_070_EQ_0_071_THEN_debu_ETC___d1325,
	       IF_debug_module_master_ar_araddr__944_BITS_63__ETC___d1970,
	       IF_proc_master1_ar_araddr__852_BITS_63_TO_40_8_ETC___d1878,
	       SEXT_SEXT_arbiter_1_1_firstHot_335_336_BIT_0_3_ETC__q22,
	       SEXT_SEXT_arbiter_1_firstHot_1_150_151_BIT_0_1_ETC__q17,
	       ...
	       SEXT_x5090__q24,
	       SEXT_x9162__q8;
  wire IF_NOT_ifcs_0_1_innerRoute_first__096_BIT_1_10_ETC___d2118,
       IF_NOT_ifcs_0_innerRoute_first__443_BIT_1_452__ETC___d1465,
       IF_NOT_ifcs_1_1_innerRoute_first__125_BIT_1_12_ETC___d2134,
       IF_NOT_ifcs_1_innerRoute_first__472_BIT_1_476__ETC___d1481,
       IF_SEXT_arbiter_1_1_lastSelect_326_327_BIT_0_3_ETC___d2370,
       IF_SEXT_arbiter_1_1_lastSelect_326_327_BIT_0_3_ETC___d2376,
       IF_SEXT_arbiter_1_1_lastSelect_326_327_BIT_0_3_ETC___d2382,
       IF_SEXT_arbiter_1_lastSelect_2_146_147_BIT_0_1_ETC___d2170,
       IF_SEXT_arbiter_1_lastSelect_2_146_147_BIT_0_1_ETC___d2174,
       IF_SEXT_arbiter_1_lastSelect_683_684_BIT_0_685_ETC___d1727,
       IF_SEXT_arbiter_1_lastSelect_683_684_BIT_0_685_ETC___d1733,
       IF_SEXT_arbiter_1_lastSelect_683_684_BIT_0_685_ETC___d1739,
       IF_SEXT_arbiter_lastSelect_493_494_BIT_0_495_A_ETC___d1517,
       IF_SEXT_arbiter_lastSelect_493_494_BIT_0_495_A_ETC___d1521,
       IF_merged_0_flitLeft_050_EQ_0_051_THEN_NOT_pro_ETC___d1180,
       IF_merged_0_flitLeft_050_EQ_0_051_THEN_NOT_pro_ETC___d1255,
       IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1173,
       IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1194,
       IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1197,
       IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1202,
       IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1205,
       ...
       IF_merged_1_flitLeft_070_EQ_0_071_THEN_NOT_deb_ETC___d1360,
       IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1283,
       IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1302,
       IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1304,
       IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1307,
       IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1309,
       IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1313,
       IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1318,
       IF_split_0_flitLeft_094_EQ_0_095_THEN_ssNoSynt_ETC___d1435,
       IF_split_1_flitLeft_123_EQ_0_124_THEN_ssNoSynt_ETC___d1436,
       IF_split_2_flitLeft_152_EQ_0_153_THEN_ssNoSynt_ETC___d1437,
       SEXT_arbiter_1_1_firstHot_335_336_BIT_0_337_AN_ETC___d2351,
       SEXT_arbiter_1_1_lastSelect_1_330_331_BIT_0_33_ETC___d2345,
       SEXT_arbiter_1_1_lastSelect_326_327_BIT_0_328__ETC___d2339,
       SEXT_arbiter_1_firstHot_1_150_151_BIT_0_152_AN_ETC___d2158,
       SEXT_arbiter_1_firstHot_692_693_BIT_0_694_AND__ETC___d1708,
       ...
       SEXT_arbiter_firstHot_497_498_BIT_0_499_AND_re_ETC___d1505,
       SEXT_arbiter_lastSelect_493_494_BIT_0_495_AND__ETC___d1501,
       debug_module_master_ar_araddr__944_BITS_63_TO__ETC___d1958,
       debug_module_master_ar_araddr__944_BITS_63_TO__ETC___d1963,
       debug_module_master_ar_araddr__944_MINUS_soc_m_ETC___d1949,
       debug_module_master_ar_araddr__944_MINUS_soc_m_ETC___d1954,
       debug_module_master_ar_araddr__944_ULT_soc_map_ETC___d1947,
       debug_module_master_ar_araddr__944_ULT_soc_map_ETC___d1952,
       proc_master1_ar_araddr__852_BITS_63_TO_40_853__ETC___d1866,
       proc_master1_ar_araddr__852_BITS_63_TO_40_853__ETC___d1871,
       proc_master1_ar_araddr__852_MINUS_soc_map_m_me_ETC___d1857,
       proc_master1_ar_araddr__852_MINUS_soc_map_m_pl_ETC___d1862,
       proc_master1_ar_araddr__852_ULT_soc_map_m_mem0_ETC___d1855,
       proc_master1_ar_araddr__852_ULT_soc_map_m_plic_ETC___d1860,
       reqWires_1_0_whas__669_AND_reqWires_1_0_wget___ETC___d1679,
       reqWires_1_1_0_whas__312_AND_reqWires_1_1_0_wg_ETC___d2322,
       split_0_doPut_whas__086_AND_split_0_doPut_wget_ETC___d1093,
       split_1_doPut_whas__115_AND_split_1_doPut_wget_ETC___d1122,
       split_2_doPut_whas__144_AND_split_2_doPut_wget_ETC___d1151,
       state_1_1_143_AND_activeSource_1_0_1_210_211_A_ETC___d2213,
       ...
       state_1_1_1_323_AND_activeSource_1_1_2_489_490_ETC___d2492,
       state_1_680_AND_activeSource_1_0_768_769_AND_i_ETC___d1771,
       state_1_680_AND_activeSource_1_1_801_802_AND_i_ETC___d1804,
       state_1_680_AND_activeSource_1_2_835_836_AND_i_ETC___d1838,
       state_490_AND_activeSource_0_563_564_AND_ifcs__ETC___d1566,
       state_490_AND_activeSource_1_607_608_AND_ifcs__ETC___d1610,
       x__h48635,
       x__h48738,
       x__h49103,
       x__h49162,
  ...
  assign cpu_dmem_master_awid =
	     ug_uncached_mem_shim_master_u_aw_peekWire$wget[98:93] ;

  // value method cpu_dmem_master_aw_awaddr
  assign cpu_dmem_master_awaddr =
	     ug_uncached_mem_shim_master_u_aw_peekWire$wget[92:29] ;

  // value method cpu_dmem_master_aw_awlen
  assign cpu_dmem_master_awlen =
	     ug_uncached_mem_shim_master_u_aw_peekWire$wget[28:21] ;

  // value method cpu_dmem_master_aw_awsize
  assign cpu_dmem_master_awsize =
	     ug_uncached_mem_shim_master_u_aw_peekWire$wget[20:18] ;

  // value method cpu_dmem_master_aw_awburst
  assign cpu_dmem_master_awburst =
	     ug_uncached_mem_shim_master_u_aw_peekWire$wget[17:16] ;

  // value method cpu_dmem_master_aw_awlock
  assign cpu_dmem_master_awlock =
	     ug_uncached_mem_shim_master_u_aw_peekWire$wget[15] ;

  // value method cpu_dmem_master_aw_awcache
  assign cpu_dmem_master_awcache =
	     ug_uncached_mem_shim_master_u_aw_peekWire$wget[14:11] ;

  // value method cpu_dmem_master_aw_awprot
  assign cpu_dmem_master_awprot =
	     ug_uncached_mem_shim_master_u_aw_peekWire$wget[10:8] ;

  // value method cpu_dmem_master_aw_awqos
  assign cpu_dmem_master_awqos =
	     ug_uncached_mem_shim_master_u_aw_peekWire$wget[7:4] ;

  // value method cpu_dmem_master_aw_awregion
  assign cpu_dmem_master_awregion =
	     ug_uncached_mem_shim_master_u_aw_peekWire$wget[3:0] ;
  ...
  assign cpu_dmem_master_arid =
	     ug_uncached_mem_shim_master_u_ar_peekWire$wget[98:93] ;

  // value method cpu_dmem_master_ar_araddr
  assign cpu_dmem_master_araddr =
	     ug_uncached_mem_shim_master_u_ar_peekWire$wget[92:29] ;

  // value method cpu_dmem_master_ar_arlen
  assign cpu_dmem_master_arlen =
	     ug_uncached_mem_shim_master_u_ar_peekWire$wget[28:21] ;

  // value method cpu_dmem_master_ar_arsize
  assign cpu_dmem_master_arsize =
	     ug_uncached_mem_shim_master_u_ar_peekWire$wget[20:18] ;

  // value method cpu_dmem_master_ar_arburst
  assign cpu_dmem_master_arburst =
	     ug_uncached_mem_shim_master_u_ar_peekWire$wget[17:16] ;

  // value method cpu_dmem_master_ar_arlock
  assign cpu_dmem_master_arlock =
	     ug_uncached_mem_shim_master_u_ar_peekWire$wget[15] ;

  // value method cpu_dmem_master_ar_arcache
  assign cpu_dmem_master_arcache =
	     ug_uncached_mem_shim_master_u_ar_peekWire$wget[14:11] ;

  // value method cpu_dmem_master_ar_arprot
  assign cpu_dmem_master_arprot =
	     ug_uncached_mem_shim_master_u_ar_peekWire$wget[10:8] ;

  // value method cpu_dmem_master_ar_arqos
  assign cpu_dmem_master_arqos =
	     ug_uncached_mem_shim_master_u_ar_peekWire$wget[7:4] ;

  // value method cpu_dmem_master_ar_arregion
  assign cpu_dmem_master_arregion =
	     ug_uncached_mem_shim_master_u_ar_peekWire$wget[3:0] ;
  ...
  FIFO1 #(.width(32'd6),
	  .guarded(32'd0)) tmp0_b_buffer_ff(.RST(hart0_reset$RST_OUT),
					    .CLK(CLK),
  ...
  FIFO1 #(.width(32'd72),
	  .guarded(32'd0)) tmp0_r_buffer_ff(.RST(hart0_reset$RST_OUT),
					    .CLK(CLK),
  ...
  // submodule tmp2_b_buffer_ff
  FIFO1 #(.width(32'd7),
	  .guarded(32'd0)) tmp2_b_buffer_ff(.RST(hart0_reset$RST_OUT),
					    .CLK(CLK),
					    .D_IN(tmp2_b_buffer_ff$D_IN),
					    .ENQ(tmp2_b_buffer_ff$ENQ),
					    .DEQ(tmp2_b_buffer_ff$DEQ),
					    .CLR(tmp2_b_buffer_ff$CLR),
					    .D_OUT(tmp2_b_buffer_ff$D_OUT),
					    .FULL_N(tmp2_b_buffer_ff$FULL_N),
					    .EMPTY_N(tmp2_b_buffer_ff$EMPTY_N));

  // submodule tmp2_b_buffer_firstValid
  RevertReg #(.width(32'd1), .init(1'd1)) tmp2_b_buffer_firstValid(.CLK(CLK),
								   .D_IN(tmp2_b_buffer_firstValid$D_IN),
								   .EN(tmp2_b_buffer_firstValid$EN),
								   .Q_OUT(tmp2_b_buffer_firstValid$Q_OUT));

  // submodule tmp2_r_buffer_ff
  FIFO1 #(.width(32'd73),
	  .guarded(32'd0)) tmp2_r_buffer_ff(.RST(hart0_reset$RST_OUT),
					    .CLK(CLK),
					    .D_IN(tmp2_r_buffer_ff$D_IN),
					    .ENQ(tmp2_r_buffer_ff$ENQ),
					    .DEQ(tmp2_r_buffer_ff$DEQ),
					    .CLR(tmp2_r_buffer_ff$CLR),
					    .D_OUT(tmp2_r_buffer_ff$D_OUT),
					    .FULL_N(tmp2_r_buffer_ff$FULL_N),
					    .EMPTY_N(tmp2_r_buffer_ff$EMPTY_N));

  // submodule tmp2_r_buffer_firstValid
  RevertReg #(.width(32'd1), .init(1'd1)) tmp2_r_buffer_firstValid(.CLK(CLK),
								   .D_IN(tmp2_r_buffer_firstValid$D_IN),
								   .EN(tmp2_r_buffer_firstValid$EN),
								   .Q_OUT(tmp2_r_buffer_firstValid$Q_OUT));
  ...
  // rule RL_ug_uncached_mem_shim_master_u_aw_setPeek
  assign CAN_FIRE_RL_ug_uncached_mem_shim_master_u_aw_setPeek =
	     uncached_mem_shim_awff$EMPTY_N ;
  assign WILL_FIRE_RL_ug_uncached_mem_shim_master_u_aw_setPeek =
	     uncached_mem_shim_awff$EMPTY_N ;

  // rule RL_ug_uncached_mem_shim_master_u_aw_warnDoDrop
  assign CAN_FIRE_RL_ug_uncached_mem_shim_master_u_aw_warnDoDrop =
	     ug_uncached_mem_shim_master_u_aw_dropWire$whas &&
	     !uncached_mem_shim_awff$EMPTY_N ;
  assign WILL_FIRE_RL_ug_uncached_mem_shim_master_u_aw_warnDoDrop =
	     CAN_FIRE_RL_ug_uncached_mem_shim_master_u_aw_warnDoDrop ;

  // rule RL_ug_uncached_mem_shim_master_u_w_setPeek
  assign CAN_FIRE_RL_ug_uncached_mem_shim_master_u_w_setPeek =
	     uncached_mem_shim_wff$EMPTY_N ;
  assign WILL_FIRE_RL_ug_uncached_mem_shim_master_u_w_setPeek =
	     uncached_mem_shim_wff$EMPTY_N ;

  // rule RL_ug_uncached_mem_shim_master_u_w_warnDoDrop
  assign CAN_FIRE_RL_ug_uncached_mem_shim_master_u_w_warnDoDrop =
	     ug_uncached_mem_shim_master_u_w_dropWire$whas &&
	     !uncached_mem_shim_wff$EMPTY_N ;
  assign WILL_FIRE_RL_ug_uncached_mem_shim_master_u_w_warnDoDrop =
	     CAN_FIRE_RL_ug_uncached_mem_shim_master_u_w_warnDoDrop ;

  // rule RL_ug_uncached_mem_shim_master_u_b_warnDoPut
  assign CAN_FIRE_RL_ug_uncached_mem_shim_master_u_b_warnDoPut =
	     ug_uncached_mem_shim_master_u_b_putWire$whas &&
	     !uncached_mem_shim_bff$FULL_N ;
  assign WILL_FIRE_RL_ug_uncached_mem_shim_master_u_b_warnDoPut =
	     CAN_FIRE_RL_ug_uncached_mem_shim_master_u_b_warnDoPut ;

  // rule RL_ug_uncached_mem_shim_master_u_ar_setPeek
  assign CAN_FIRE_RL_ug_uncached_mem_shim_master_u_ar_setPeek =
	     uncached_mem_shim_arff$EMPTY_N ;
  assign WILL_FIRE_RL_ug_uncached_mem_shim_master_u_ar_setPeek =
	     uncached_mem_shim_arff$EMPTY_N ;

  // rule RL_ug_uncached_mem_shim_master_u_ar_warnDoDrop
  assign CAN_FIRE_RL_ug_uncached_mem_shim_master_u_ar_warnDoDrop =
	     ug_uncached_mem_shim_master_u_ar_dropWire$whas &&
	     !uncached_mem_shim_arff$EMPTY_N ;
  assign WILL_FIRE_RL_ug_uncached_mem_shim_master_u_ar_warnDoDrop =
	     CAN_FIRE_RL_ug_uncached_mem_shim_master_u_ar_warnDoDrop ;

  // rule RL_ug_uncached_mem_shim_master_u_r_warnDoPut
  assign CAN_FIRE_RL_ug_uncached_mem_shim_master_u_r_warnDoPut =
	     ug_uncached_mem_shim_master_u_r_putWire$whas &&
	     !uncached_mem_shim_rff$FULL_N ;
  assign WILL_FIRE_RL_ug_uncached_mem_shim_master_u_r_warnDoPut =
	     CAN_FIRE_RL_ug_uncached_mem_shim_master_u_r_warnDoPut ;
  ...
  // rule RL_Prelude_inst_changeSpecialWires_mkConnectionGetPut
  assign CAN_FIRE_RL_Prelude_inst_changeSpecialWires_mkConnectionGetPut =
	     !tagController_tmp_shimSlave_awff_rv[98] &&
	     proc$master0_awvalid ;
  assign WILL_FIRE_RL_Prelude_inst_changeSpecialWires_mkConnectionGetPut =
	     CAN_FIRE_RL_Prelude_inst_changeSpecialWires_mkConnectionGetPut ;
  ...
  // rule RL_tmp2_aw_forwardReady
  assign CAN_FIRE_RL_tmp2_aw_forwardReady = 1'd1 ;
  assign WILL_FIRE_RL_tmp2_aw_forwardReady = 1'd1 ;

  // rule RL_Prelude_inst_changeSpecialWires_1_mkConnectionGetPut
  assign CAN_FIRE_RL_Prelude_inst_changeSpecialWires_1_mkConnectionGetPut =
	     !tagController_tmp_shimSlave_wff_rv[74] && proc$master0_wvalid ;
  assign WILL_FIRE_RL_Prelude_inst_changeSpecialWires_1_mkConnectionGetPut =
	     CAN_FIRE_RL_Prelude_inst_changeSpecialWires_1_mkConnectionGetPut ;
  ...
  // rule RL_tmp2_w_forwardReady
  assign CAN_FIRE_RL_tmp2_w_forwardReady = 1'd1 ;
  assign WILL_FIRE_RL_tmp2_w_forwardReady = 1'd1 ;
  ...
  // rule RL_tmp2_b_forwardFlit
  assign CAN_FIRE_RL_tmp2_b_forwardFlit =
	     tmp2_b_buffer_firstValid$Q_OUT &&
	     (tmp2_b_buffer_ff$EMPTY_N ||
	      CAN_FIRE_RL_Prelude_inst_changeSpecialWires_2_mkConnectionGetPut) ;
  assign WILL_FIRE_RL_tmp2_b_forwardFlit = CAN_FIRE_RL_tmp2_b_forwardFlit ;

  // rule RL_tmp2_b_dropFlit
  assign CAN_FIRE_RL_tmp2_b_dropFlit =
	     (tmp2_b_buffer_ff$EMPTY_N ||
	      CAN_FIRE_RL_Prelude_inst_changeSpecialWires_2_mkConnectionGetPut) &&
	     proc$master0_bready ;
  assign WILL_FIRE_RL_tmp2_b_dropFlit = CAN_FIRE_RL_tmp2_b_dropFlit ;

  // rule RL_tmp2_b_buffer_enqueue
  assign CAN_FIRE_RL_tmp2_b_buffer_enqueue =
	     CAN_FIRE_RL_Prelude_inst_changeSpecialWires_2_mkConnectionGetPut &&
	     (!CAN_FIRE_RL_tmp2_b_dropFlit || tmp2_b_buffer_ff$EMPTY_N) ;
  assign WILL_FIRE_RL_tmp2_b_buffer_enqueue =
	     CAN_FIRE_RL_tmp2_b_buffer_enqueue ;

  // rule RL_tmp2_b_buffer_dequeue
  assign CAN_FIRE_RL_tmp2_b_buffer_dequeue =
	     CAN_FIRE_RL_tmp2_b_dropFlit && tmp2_b_buffer_ff$EMPTY_N ;
  assign WILL_FIRE_RL_tmp2_b_buffer_dequeue =
	     CAN_FIRE_RL_tmp2_b_buffer_dequeue ;
  ...
  // rule RL_tmp2_ar_forwardReady
  assign CAN_FIRE_RL_tmp2_ar_forwardReady = 1'd1 ;
  assign WILL_FIRE_RL_tmp2_ar_forwardReady = 1'd1 ;

  // rule RL_Prelude_inst_changeSpecialWires_4_mkConnectionGetPut
  assign CAN_FIRE_RL_Prelude_inst_changeSpecialWires_4_mkConnectionGetPut =
	     tagController_tmp_shimSlave_rff_rv$port1__read[73] &&
	     tmp2_r_buffer_ff$FULL_N ;
  assign WILL_FIRE_RL_Prelude_inst_changeSpecialWires_4_mkConnectionGetPut =
	     CAN_FIRE_RL_Prelude_inst_changeSpecialWires_4_mkConnectionGetPut ;
  ...
  // rule RL_tmp2_r_forwardFlit
  assign CAN_FIRE_RL_tmp2_r_forwardFlit =
	     tmp2_r_buffer_firstValid$Q_OUT &&
	     (tmp2_r_buffer_ff$EMPTY_N ||
	      CAN_FIRE_RL_Prelude_inst_changeSpecialWires_4_mkConnectionGetPut) ;
  assign WILL_FIRE_RL_tmp2_r_forwardFlit = CAN_FIRE_RL_tmp2_r_forwardFlit ;

  // rule RL_tmp2_r_dropFlit
  assign CAN_FIRE_RL_tmp2_r_dropFlit =
	     (tmp2_r_buffer_ff$EMPTY_N ||
	      CAN_FIRE_RL_Prelude_inst_changeSpecialWires_4_mkConnectionGetPut) &&
	     proc$master0_rready ;
  assign WILL_FIRE_RL_tmp2_r_dropFlit = CAN_FIRE_RL_tmp2_r_dropFlit ;

  // rule RL_tmp2_r_buffer_enqueue
  assign CAN_FIRE_RL_tmp2_r_buffer_enqueue =
	     CAN_FIRE_RL_Prelude_inst_changeSpecialWires_4_mkConnectionGetPut &&
	     (!CAN_FIRE_RL_tmp2_r_dropFlit || tmp2_r_buffer_ff$EMPTY_N) ;
  assign WILL_FIRE_RL_tmp2_r_buffer_enqueue =
	     CAN_FIRE_RL_tmp2_r_buffer_enqueue ;

  // rule RL_tmp2_r_buffer_dequeue
  assign CAN_FIRE_RL_tmp2_r_buffer_dequeue =
	     CAN_FIRE_RL_tmp2_r_dropFlit && tmp2_r_buffer_ff$EMPTY_N ;
  assign WILL_FIRE_RL_tmp2_r_buffer_dequeue =
	     CAN_FIRE_RL_tmp2_r_buffer_dequeue ;
  ...
  // rule RL_ug_uncached_mem_shim_master_u_ar_doDrop
  assign CAN_FIRE_RL_ug_uncached_mem_shim_master_u_ar_doDrop =
	     uncached_mem_shim_arff$EMPTY_N &&
	     ug_uncached_mem_shim_master_u_ar_dropWire$whas ;
  assign WILL_FIRE_RL_ug_uncached_mem_shim_master_u_ar_doDrop =
	     CAN_FIRE_RL_ug_uncached_mem_shim_master_u_ar_doDrop ;
  ...
  // rule RL_ug_uncached_mem_shim_master_u_aw_doDrop
  assign CAN_FIRE_RL_ug_uncached_mem_shim_master_u_aw_doDrop =
	     uncached_mem_shim_awff$EMPTY_N &&
	     ug_uncached_mem_shim_master_u_aw_dropWire$whas ;
  assign WILL_FIRE_RL_ug_uncached_mem_shim_master_u_aw_doDrop =
	     CAN_FIRE_RL_ug_uncached_mem_shim_master_u_aw_doDrop ;
  ...
  // rule RL_ug_uncached_mem_shim_master_u_w_doDrop
  assign CAN_FIRE_RL_ug_uncached_mem_shim_master_u_w_doDrop =
	     uncached_mem_shim_wff$EMPTY_N &&
	     ug_uncached_mem_shim_master_u_w_dropWire$whas ;
  assign WILL_FIRE_RL_ug_uncached_mem_shim_master_u_w_doDrop =
	     CAN_FIRE_RL_ug_uncached_mem_shim_master_u_w_doDrop ;
  ...
  assign CAN_FIRE_RL_ifcs_0_firstFlit =
	     ...
	     (IF_merged_0_flitLeft_050_EQ_0_051_THEN_NOT_pro_ETC___d1180 ||
	      proc$master1_awvalid) &&
	     ifcs_0_state == 2'd0 &&
	     IF_IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ETC___d1221 ==
	     2'd1 ;
  ...
  assign CAN_FIRE_RL_tmp0_b_forwardFlit =
	     tmp0_b_buffer_firstValid$Q_OUT &&
	     (tmp0_b_buffer_ff$EMPTY_N || tmp0_b_buffer_enqw$whas) ;
  ...
  assign CAN_FIRE_RL_ifcs_0_firstFlit_1 =
	     uncached_mem_shim_bff$EMPTY_N && ifcs_0_rspBack$FULL_N &&
	     ifcs_0_routeBack$FULL_N &&
	     !ifcs_0_state_1 ;
  ...
  assign CAN_FIRE_RL_ssNoSynth_0_b_forwardReady = 1'b1 ;
  assign WILL_FIRE_RL_ssNoSynth_0_b_forwardReady = 1'b1 ;

  // rule RL_ug_uncached_mem_shim_master_u_b_doPut
  assign CAN_FIRE_RL_ug_uncached_mem_shim_master_u_b_doPut =
	     uncached_mem_shim_bff$FULL_N &&
	     ug_uncached_mem_shim_master_u_b_putWire$whas ;
  assign WILL_FIRE_RL_ug_uncached_mem_shim_master_u_b_doPut =
	     CAN_FIRE_RL_ug_uncached_mem_shim_master_u_b_doPut ;
  ...
  assign CAN_FIRE_RL_tmp0_r_forwardFlit =
	     tmp0_r_buffer_firstValid$Q_OUT &&
	     (tmp0_r_buffer_ff$EMPTY_N || tmp0_r_buffer_enqw$whas) ;
  ...
  assign CAN_FIRE_RL_ifcs_0_1_nonRoutableGenRsp =
	     x_port1__read__h73054 != 9'd0 && ifcs_0_1_noRouteRsp$FULL_N &&
	     (x_port1__read__h73054 != 9'd1 || proc$master1_arvalid) ;
  ...
  assign CAN_FIRE_RL_ifcs_1_1_nonRoutableGenRsp =
	     x_port1__read__h75518 != 9'd0 && ifcs_1_1_noRouteRsp$FULL_N &&
	     (x_port1__read__h75518 != 9'd1 || debug_module$master_arvalid) ;
  ...
  assign CAN_FIRE_RL_ifcs_0_1_firstFlit_1 =
	     uncached_mem_shim_rff$EMPTY_N && ifcs_0_1_rspBack$FULL_N &&
	     ifcs_0_1_routeBack$FULL_N &&
	     !ifcs_0_1_state_1 ;
  ...
  assign CAN_FIRE_RL_ssNoSynth_0_r_forwardReady = 1'b1 ;
  assign WILL_FIRE_RL_ssNoSynth_0_r_forwardReady = 1'b1 ;

  // rule RL_ug_uncached_mem_shim_master_u_r_doPut
  assign CAN_FIRE_RL_ug_uncached_mem_shim_master_u_r_doPut =
	     uncached_mem_shim_rff$FULL_N &&
	     ug_uncached_mem_shim_master_u_r_putWire$whas ;
  assign WILL_FIRE_RL_ug_uncached_mem_shim_master_u_r_doPut =
	     CAN_FIRE_RL_ug_uncached_mem_shim_master_u_r_doPut ;
  ...
  // inlined wires
  assign tmp0_aw_dwReady$whas =
	     proc$master1_awvalid && CAN_FIRE_RL_merged_0_genFirst ;
  assign tmp0_w_dwReady$whas =
	     proc$master1_wvalid && msNoSynth_0_w_dwReady$whas ;
  assign tmp0_b_buffer_enqw$wget =
	     msNoSynth_0_b_buffer_ff$EMPTY_N ?
	       msNoSynth_0_b_buffer_ff$D_OUT :
	       msNoSynth_0_b_buffer_enqw$wget ;
  assign tmp0_b_buffer_enqw$whas =
	     WILL_FIRE_RL_msNoSynth_0_b_forwardFlit &&
	     tmp0_b_buffer_ff$FULL_N ;
  assign tmp0_ar_dwReady$whas =
	     proc$master1_arvalid && msNoSynth_0_ar_dwReady$whas ;
  assign tmp0_r_buffer_enqw$wget =
		 ...
		 msNoSynth_0_r_buffer_enqw$wget[1],
	       1'd0 } ;
  assign tmp0_r_buffer_enqw$whas =
	     WILL_FIRE_RL_msNoSynth_0_r_forwardFlit &&
	     tmp0_r_buffer_ff$FULL_N ;
  assign ug_uncached_mem_shim_master_u_aw_peekWire$wget =
	     { 1'd0, uncached_mem_shim_awff$D_OUT } ;
  assign ug_uncached_mem_shim_master_u_b_putWire$wget =
	     { cpu_dmem_master_bid, cpu_dmem_master_bresp } ;
  assign ug_uncached_mem_shim_master_u_b_putWire$whas =
	     cpu_dmem_master_bvalid && uncached_mem_shim_bff$FULL_N ;
  assign ug_uncached_mem_shim_master_u_ar_peekWire$wget =
	     { 1'd0, uncached_mem_shim_arff$D_OUT } ;
  assign ug_uncached_mem_shim_master_u_r_putWire$wget =
	     { cpu_dmem_master_rid,
	       cpu_dmem_master_rdata,
	       cpu_dmem_master_rresp,
	       cpu_dmem_master_rlast } ;
  assign ug_uncached_mem_shim_master_u_r_putWire$whas =
  ...
  assign tagController_tmp_ug_master_u_r_putWire$whas =
	     cpu_imem_master_rvalid &&
	     !tagController_tmp_shimMaster_rff_rv[73] ;
  assign tmp2_b_buffer_enqw$wget =
	     tagController_tmp_shimSlave_bff_rv$port1__read[6:0] ;
  assign tmp2_r_buffer_enqw$wget =
  ...
  assign reqWires_1_0_1$wget =
	     (!ifcs_0_1_innerRoute$D_OUT[0] ||
	      !ssNoSynth_0_ar_buffer_ff$FULL_N) ?
	       IF_NOT_ifcs_0_1_innerRoute_first__096_BIT_1_10_ETC___d2118 :
	       ifcs_0_1_innerRoute$D_OUT[0] ;
  ...
  assign flitToSink_1_1_1_1$whas =
	     ...
	     WILL_FIRE_RL_source_selected_9 && ifcs_2_1_routeBack$EMPTY_N &&
	     ifcs_2_1_routeBack$D_OUT[1] ;
  assign ug_uncached_mem_shim_master_u_aw_dropWire$whas =
	     uncached_mem_shim_awff$EMPTY_N && cpu_dmem_master_awready ;
  assign ug_uncached_mem_shim_master_u_w_dropWire$whas =
	     uncached_mem_shim_wff$EMPTY_N && cpu_dmem_master_wready ;
  assign ug_uncached_mem_shim_master_u_ar_dropWire$whas =
  ...
  // submodule ifcs_0_1_routeBack
  assign ifcs_0_1_routeBack$D_IN = 2'd1 << uncached_mem_shim_rff$D_OUT[72] ;
  ...
  // submodule ifcs_0_1_rspBack
  assign ifcs_0_1_rspBack$D_IN = uncached_mem_shim_rff$D_OUT[71:0] ;
  ...
  // submodule ifcs_0_routeBack
  assign ifcs_0_routeBack$D_IN = 2'd1 << uncached_mem_shim_bff$D_OUT[6] ;
  ...
  // submodule ifcs_0_rspBack
  assign ifcs_0_rspBack$D_IN = uncached_mem_shim_bff$D_OUT[5:0] ;
  ...
  assign proc$m_external_interrupt_req_set_not_clear =
	     plic$v_targets_0_m_eip ;
  assign proc$master0_arready =
	     CAN_FIRE_RL_Prelude_inst_changeSpecialWires_3_mkConnectionGetPut ;
  assign proc$master0_awready =
	     CAN_FIRE_RL_Prelude_inst_changeSpecialWires_mkConnectionGetPut ;
  assign proc$master0_bid =
	     tmp2_b_buffer_ff$EMPTY_N ?
	       tmp2_b_buffer_ff$D_OUT[6:2] :
	       tmp2_b_buffer_enqw$wget[6:2] ;
  assign proc$master0_bresp =
	     tmp2_b_buffer_ff$EMPTY_N ?
	       tmp2_b_buffer_ff$D_OUT[1:0] :
	       tmp2_b_buffer_enqw$wget[1:0] ;
  assign proc$master0_rdata =
	     tmp2_r_buffer_ff$EMPTY_N ?
	       tmp2_r_buffer_ff$D_OUT[67:4] :
	       tmp2_r_buffer_enqw$wget[67:4] ;
  assign proc$master0_rid =
	     tmp2_r_buffer_ff$EMPTY_N ?
	       tmp2_r_buffer_ff$D_OUT[72:68] :
	       tmp2_r_buffer_enqw$wget[72:68] ;
  assign proc$master0_rlast =
	     tmp2_r_buffer_ff$EMPTY_N ?
	       tmp2_r_buffer_ff$D_OUT[1] :
	       tmp2_r_buffer_enqw$wget[1] ;
  assign proc$master0_rresp =
	     tmp2_r_buffer_ff$EMPTY_N ?
	       tmp2_r_buffer_ff$D_OUT[3:2] :
	       tmp2_r_buffer_enqw$wget[3:2] ;
  assign proc$master0_ruser =
	     tmp2_r_buffer_ff$EMPTY_N ?
	       tmp2_r_buffer_ff$D_OUT[0] :
	       tmp2_r_buffer_enqw$wget[0] ;
  assign proc$master0_wready =
	     CAN_FIRE_RL_Prelude_inst_changeSpecialWires_1_mkConnectionGetPut ;
  assign proc$master1_arready = tmp0_ar_dwReady$whas ;
  assign proc$master1_awready = tmp0_aw_dwReady$whas ;
  assign proc$master1_bid =
	     tmp0_b_buffer_ff$EMPTY_N ?
	       tmp0_b_buffer_ff$D_OUT[5:2] :
	       tmp0_b_buffer_enqw$wget[5:2] ;
  ...
  assign proc$master1_rid =
	     tmp0_r_buffer_ff$EMPTY_N ?
	       tmp0_r_buffer_ff$D_OUT[71:68] :
	       tmp0_r_buffer_enqw$wget[71:68] ;
  ...
  assign proc$master1_wready = tmp0_w_dwReady$whas ;
  ...
  assign proc$EN_start =
	     ...
	     rg_hart0_reset_delay == 8'd1 ||
	     EN_start ;
  assign proc$master0_bvalid = CAN_FIRE_RL_tmp2_b_forwardFlit ;
  assign proc$master0_rvalid = CAN_FIRE_RL_tmp2_r_forwardFlit ;
  assign proc$master1_bvalid = CAN_FIRE_RL_tmp0_b_forwardFlit ;
  assign proc$master1_rvalid = CAN_FIRE_RL_tmp0_r_forwardFlit ;
  ...
  // submodule tmp2_b_buffer_ff
  assign tmp2_b_buffer_ff$D_IN =
	     tagController_tmp_shimSlave_bff_rv$port1__read[6:0] ;
  assign tmp2_b_buffer_ff$ENQ = CAN_FIRE_RL_tmp2_b_buffer_enqueue ;
  assign tmp2_b_buffer_ff$DEQ = CAN_FIRE_RL_tmp2_b_buffer_dequeue ;
  assign tmp2_b_buffer_ff$CLR = 1'b0 ;

  // submodule tmp2_b_buffer_firstValid
  assign tmp2_b_buffer_firstValid$D_IN = 1'd1 ;
  assign tmp2_b_buffer_firstValid$EN = CAN_FIRE_RL_tmp2_b_dropFlit ;

  // submodule tmp2_r_buffer_ff
  assign tmp2_r_buffer_ff$D_IN =
	     tagController_tmp_shimSlave_rff_rv$port1__read[72:0] ;
  assign tmp2_r_buffer_ff$ENQ = CAN_FIRE_RL_tmp2_r_buffer_enqueue ;
  assign tmp2_r_buffer_ff$DEQ = CAN_FIRE_RL_tmp2_r_buffer_dequeue ;
  assign tmp2_r_buffer_ff$CLR = 1'b0 ;

  // submodule tmp2_r_buffer_firstValid
  assign tmp2_r_buffer_firstValid$D_IN = 1'd1 ;
  assign tmp2_r_buffer_firstValid$EN = CAN_FIRE_RL_tmp2_r_dropFlit ;
  ...
  assign uncached_mem_shim_bff$D_IN =
	     ug_uncached_mem_shim_master_u_b_putWire$wget[6:0] ;
  assign uncached_mem_shim_bff$ENQ =
	     CAN_FIRE_RL_ug_uncached_mem_shim_master_u_b_doPut ;
  assign uncached_mem_shim_bff$DEQ =
	     uncached_mem_shim_bff$EMPTY_N && ssNoSynth_0_b_dwReady$whas ;
  assign uncached_mem_shim_bff$CLR = 1'b0 ;

  // submodule uncached_mem_shim_rff
  assign uncached_mem_shim_rff$D_IN =
	     { ug_uncached_mem_shim_master_u_r_putWire$wget[71:0], 1'd0 } ;
  assign uncached_mem_shim_rff$ENQ =
	     CAN_FIRE_RL_ug_uncached_mem_shim_master_u_r_doPut ;
  assign uncached_mem_shim_rff$DEQ =
	     uncached_mem_shim_rff$EMPTY_N && ssNoSynth_0_r_dwReady$whas ;
  assign uncached_mem_shim_rff$CLR = 1'b0 ;

  // submodule uncached_mem_shim_wff
  assign uncached_mem_shim_wff$D_IN =
	     ssNoSynth_0_w_buffer_ff$EMPTY_N ?
  ...
  // remaining internal signals
  assign IF_IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ETC___d1221 =
	     (IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1209 ?
		2'd1 :
		2'd0) +
	     (IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1214 ?
		...
		2'd1 :
		2'd0) ;
  assign IF_IF_merged_1_flitLeft_070_EQ_0_071_THEN_debu_ETC___d1325 =
	     (IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1313 ?
		2'd1 :
		2'd0) +
	     (IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1318 ?
		...
		2'd1 :
		2'd0) ;
  assign IF_NOT_ifcs_0_1_innerRoute_first__096_BIT_1_10_ETC___d2118 =
	     (!ifcs_0_1_innerRoute$D_OUT[1] ||
	      !ssNoSynth_1_ar_buffer_ff$FULL_N) ?
	       ifcs_0_1_innerRoute$D_OUT[2] &&
	       ssNoSynth_2_ar_buffer_ff$FULL_N :
	       ifcs_0_1_innerRoute$D_OUT[1] ;
  assign IF_NOT_ifcs_0_innerRoute_first__443_BIT_1_452__ETC___d1465 =
	     (!ifcs_0_innerRoute$D_OUT[1] ||
	      !IF_split_1_flitLeft_123_EQ_0_124_THEN_ssNoSynt_ETC___d1436) ?
	       ifcs_0_innerRoute$D_OUT[2] &&
	       IF_split_2_flitLeft_152_EQ_0_153_THEN_ssNoSynt_ETC___d1437 :
	       ifcs_0_innerRoute$D_OUT[1] ;
  assign IF_NOT_ifcs_1_1_innerRoute_first__125_BIT_1_12_ETC___d2134 =
	     (!ifcs_1_1_innerRoute$D_OUT[1] ||
	      !ssNoSynth_1_ar_buffer_ff$FULL_N) ?
	       ifcs_1_1_innerRoute$D_OUT[2] &&
	       ssNoSynth_2_ar_buffer_ff$FULL_N :
	       ifcs_1_1_innerRoute$D_OUT[1] ;
  assign IF_NOT_ifcs_1_innerRoute_first__472_BIT_1_476__ETC___d1481 =
	     (!ifcs_1_innerRoute$D_OUT[1] ||
	      !IF_split_1_flitLeft_123_EQ_0_124_THEN_ssNoSynt_ETC___d1436) ?
	       ifcs_1_innerRoute$D_OUT[2] &&
	       IF_split_2_flitLeft_152_EQ_0_153_THEN_ssNoSynt_ETC___d1437 :
	       ifcs_1_innerRoute$D_OUT[1] ;
  assign IF_SEXT_arbiter_1_1_lastSelect_326_327_BIT_0_3_ETC___d2370 =
	     (SEXT_arbiter_1_1_lastSelect_326_327_BIT_0_328__ETC___d2339 ||
	      SEXT_arbiter_1_1_lastSelect_1_330_331_BIT_0_33_ETC___d2345 ||
	      SEXT_arbiter_1_1_firstHot_335_336_BIT_0_337_AN_ETC___d2351) ?
	       x__h94994 | y__h94995 :
	       arbiter_1_1_lastSelect ;
  assign IF_SEXT_arbiter_1_1_lastSelect_326_327_BIT_0_3_ETC___d2376 =
	     (SEXT_arbiter_1_1_lastSelect_326_327_BIT_0_328__ETC___d2339 ||
	      SEXT_arbiter_1_1_lastSelect_1_330_331_BIT_0_33_ETC___d2345 ||
	      SEXT_arbiter_1_1_firstHot_335_336_BIT_0_337_AN_ETC___d2351) ?
	       x__h95182 | y__h95183 :
	       arbiter_1_1_lastSelect_1 ;
  assign IF_SEXT_arbiter_1_1_lastSelect_326_327_BIT_0_3_ETC___d2382 =
	     (SEXT_arbiter_1_1_lastSelect_326_327_BIT_0_328__ETC___d2339 ||
	      SEXT_arbiter_1_1_lastSelect_1_330_331_BIT_0_33_ETC___d2345 ||
	      SEXT_arbiter_1_1_firstHot_335_336_BIT_0_337_AN_ETC___d2351) ?
	       x__h95363 | y__h95364 :
	       arbiter_1_1_firstHot ;
  assign IF_SEXT_arbiter_1_lastSelect_2_146_147_BIT_0_1_ETC___d2170 =
	     (SEXT_arbiter_1_lastSelect_2_146_147_BIT_0_148__ETC___d2154 ||
	      SEXT_arbiter_1_firstHot_1_150_151_BIT_0_152_AN_ETC___d2158) ?
	       x__h83052 | y__h83053 :
	       arbiter_1_lastSelect_2 ;
  assign IF_SEXT_arbiter_1_lastSelect_2_146_147_BIT_0_1_ETC___d2174 =
	     (SEXT_arbiter_1_lastSelect_2_146_147_BIT_0_148__ETC___d2154 ||
	      SEXT_arbiter_1_firstHot_1_150_151_BIT_0_152_AN_ETC___d2158) ?
	       x__h83193 | y__h83194 :
	       arbiter_1_firstHot_1 ;
  assign IF_SEXT_arbiter_1_lastSelect_683_684_BIT_0_685_ETC___d1727 =
	     (SEXT_arbiter_1_lastSelect_683_684_BIT_0_685_AN_ETC___d1696 ||
	      SEXT_arbiter_1_lastSelect_1_687_688_BIT_0_689__ETC___d1702 ||
	      SEXT_arbiter_1_firstHot_692_693_BIT_0_694_AND__ETC___d1708) ?
	       x__h63586 | y__h63587 :
	       arbiter_1_lastSelect ;
  assign IF_SEXT_arbiter_1_lastSelect_683_684_BIT_0_685_ETC___d1733 =
	     (SEXT_arbiter_1_lastSelect_683_684_BIT_0_685_AN_ETC___d1696 ||
	      SEXT_arbiter_1_lastSelect_1_687_688_BIT_0_689__ETC___d1702 ||
	      SEXT_arbiter_1_firstHot_692_693_BIT_0_694_AND__ETC___d1708) ?
	       x__h63774 | y__h63775 :
	       arbiter_1_lastSelect_1 ;
  assign IF_SEXT_arbiter_1_lastSelect_683_684_BIT_0_685_ETC___d1739 =
	     (SEXT_arbiter_1_lastSelect_683_684_BIT_0_685_AN_ETC___d1696 ||
	      SEXT_arbiter_1_lastSelect_1_687_688_BIT_0_689__ETC___d1702 ||
	      SEXT_arbiter_1_firstHot_692_693_BIT_0_694_AND__ETC___d1708) ?
	       x__h63955 | y__h63956 :
	       arbiter_1_firstHot ;
  assign IF_SEXT_arbiter_lastSelect_493_494_BIT_0_495_A_ETC___d1517 =
	     (SEXT_arbiter_lastSelect_493_494_BIT_0_495_AND__ETC___d1501 ||
	      SEXT_arbiter_firstHot_497_498_BIT_0_499_AND_re_ETC___d1505) ?
	       x__h49103 | y__h49104 :
	       arbiter_lastSelect ;
  assign IF_SEXT_arbiter_lastSelect_493_494_BIT_0_495_A_ETC___d1521 =
	     (SEXT_arbiter_lastSelect_493_494_BIT_0_495_AND__ETC___d1501 ||
	      SEXT_arbiter_firstHot_497_498_BIT_0_499_AND_re_ETC___d1505) ?
	       x__h49244 | y__h49245 :
	       arbiter_firstHot ;
  assign IF_debug_module_master_ar_araddr__944_BITS_63__ETC___d1970 =
	     (debug_module_master_ar_araddr__944_BITS_63_TO__ETC___d1958 ?
		2'd1 :
		2'd0) +
	     (debug_module_master_ar_araddr__944_BITS_63_TO__ETC___d1963 ?
		...
		2'd1 :
		2'd0) ;
  assign IF_merged_0_flitLeft_050_EQ_0_051_THEN_NOT_pro_ETC___d1180 =
	     ((merged_0_flitLeft == 8'd0) ?
		!proc$master1_awvalid || !proc$master1_wvalid :
		!proc$master1_wvalid) ||
	     merged_0_flitLeft != 8'd0 ;
  assign IF_merged_0_flitLeft_050_EQ_0_051_THEN_NOT_pro_ETC___d1255 =
	     (IF_merged_0_flitLeft_050_EQ_0_051_THEN_NOT_pro_ETC___d1180 ||
	      proc$master1_awvalid) &&
	     (merged_0_flitLeft != 8'd0 ||
	      !ifcs_0_noRoute_inner_pendingReq && proc$master1_awvalid) ;
  assign IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1173 =
	     (merged_0_flitLeft == 8'd0) ?
	       proc$master1_awvalid && proc$master1_wvalid :
	       proc$master1_wvalid ;
  assign IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1194 =
	     proc$master1_awaddr <
	     soc_map$m_mem0_controller_addr_range[127:64] ;
  assign IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1197 =
	     x__h37445 < soc_map$m_mem0_controller_addr_range[63:0] ;
  assign IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1202 =
	     proc$master1_awaddr < soc_map$m_plic_addr_range[127:64] ;
  assign IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1205 =
	     x__h37480 < soc_map$m_plic_addr_range[63:0] ;
  assign IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1209 =
	     proc$master1_awaddr[63:40] == 24'd0 &&
	     (IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1194 ||
	      !IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1197) &&
	     (IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1202 ||
	      !IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1205) ;
  assign IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1214 =
	     proc$master1_awaddr[63:40] == 24'd0 &&
	     (IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1194 ||
	      !IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1197) &&
	     !IF_merged_0_flitLeft_050_EQ_0_051_THEN_proc_ma_ETC___d1202 &&
  ...
  assign IF_merged_1_flitLeft_070_EQ_0_071_THEN_NOT_deb_ETC___d1290 =
		...
		!debug_module$master_wvalid) ||
	     merged_1_flitLeft != 8'd0 ;
  assign IF_merged_1_flitLeft_070_EQ_0_071_THEN_NOT_deb_ETC___d1360 =
	     (IF_merged_1_flitLeft_070_EQ_0_071_THEN_NOT_deb_ETC___d1290 ||
	      debug_module$master_awvalid) &&
	     (merged_1_flitLeft != 8'd0 ||
	      !ifcs_1_noRoute_inner_pendingReq &&
	      debug_module$master_awvalid) ;
  assign IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1283 =
	     (merged_1_flitLeft == 8'd0) ?
	       debug_module$master_awvalid && debug_module$master_wvalid :
	       debug_module$master_wvalid ;
  assign IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1302 =
	     debug_module$master_awaddr <
	     soc_map$m_mem0_controller_addr_range[127:64] ;
  assign IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1304 =
	     x__h40257 < soc_map$m_mem0_controller_addr_range[63:0] ;
  assign IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1307 =
	     debug_module$master_awaddr < soc_map$m_plic_addr_range[127:64] ;
  assign IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1309 =
	     x__h40282 < soc_map$m_plic_addr_range[63:0] ;
  assign IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1313 =
	     debug_module$master_awaddr[63:40] == 24'd0 &&
	     (IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1302 ||
	      !IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1304) &&
	     (IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1307 ||
	      !IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1309) ;
  assign IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1318 =
	     debug_module$master_awaddr[63:40] == 24'd0 &&
	     (IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1302 ||
	      !IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1304) &&
	     !IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1307 &&
	     IF_merged_1_flitLeft_070_EQ_0_071_THEN_debug_m_ETC___d1309 ;
  assign IF_proc_master1_ar_araddr__852_BITS_63_TO_40_8_ETC___d1878 =
	     (proc_master1_ar_araddr__852_BITS_63_TO_40_853__ETC___d1866 ?
		2'd1 :
		2'd0) +
	     (proc_master1_ar_araddr__852_BITS_63_TO_40_853__ETC___d1871 ?
		...
		2'd1 :
		2'd0) ;
  assign IF_split_0_flitLeft_094_EQ_0_095_THEN_ssNoSynt_ETC___d1435 =
	     (split_0_flitLeft == 8'd0) ?
	       ssNoSynth_0_aw_buffer_ff$FULL_N &&
	       ssNoSynth_0_w_buffer_ff$FULL_N :
	       ssNoSynth_0_w_buffer_ff$FULL_N ;
  assign IF_split_1_flitLeft_123_EQ_0_124_THEN_ssNoSynt_ETC___d1436 =
	     (split_1_flitLeft == 8'd0) ?
	       ssNoSynth_1_aw_buffer_ff$FULL_N &&
	       ssNoSynth_1_w_buffer_ff$FULL_N :
	       ssNoSynth_1_w_buffer_ff$FULL_N ;
  assign IF_split_2_flitLeft_152_EQ_0_153_THEN_ssNoSynt_ETC___d1437 =
	     (split_2_flitLeft == 8'd0) ?
	       ssNoSynth_2_aw_buffer_ff$FULL_N &&
	       ssNoSynth_2_w_buffer_ff$FULL_N :
	       ssNoSynth_2_w_buffer_ff$FULL_N ;
  assign SEXT_SEXT_arbiter_1_1_firstHot_335_336_BIT_0_3_ETC__q22 =
	     {2{SEXT_arbiter_1_1_firstHot_335_336_BIT_0_337_AN_ETC___d2351}} ;
  assign SEXT_SEXT_arbiter_1_firstHot_1_150_151_BIT_0_1_ETC__q17 =
	     {2{SEXT_arbiter_1_firstHot_1_150_151_BIT_0_152_AN_ETC___d2158}} ;
  assign SEXT_SEXT_arbiter_1_firstHot_692_693_BIT_0_694_ETC__q12 =
	     {2{SEXT_arbiter_1_firstHot_692_693_BIT_0_694_AND__ETC___d1708}} ;
  assign SEXT_SEXT_arbiter_firstHot_497_498_BIT_0_499_A_ETC__q7 =
	     {2{SEXT_arbiter_firstHot_497_498_BIT_0_499_AND_re_ETC___d1505}} ;
  assign SEXT_arbiter_1_1_firstHot_335_336_BIT_0_337_AN_ETC___d2351 =
	     x__h94522 | y__h94523 ;
  assign SEXT_arbiter_1_1_firstHot__q19 = {2{arbiter_1_1_firstHot}} ;
  assign SEXT_arbiter_1_1_lastSelect_1_330_331_BIT_0_33_ETC___d2345 =
	     x__h94386 | y__h94387 ;
  assign SEXT_arbiter_1_1_lastSelect_1__q21 = {2{arbiter_1_1_lastSelect_1}} ;
  assign SEXT_arbiter_1_1_lastSelect_326_327_BIT_0_328__ETC___d2339 =
	     x__h94235 | y__h94236 ;
  assign SEXT_arbiter_1_1_lastSelect__q20 = {2{arbiter_1_1_lastSelect}} ;
  assign SEXT_arbiter_1_firstHot_1_150_151_BIT_0_152_AN_ETC___d2158 =
	     x__h82687 | y__h82688 ;
  assign SEXT_arbiter_1_firstHot_1__q15 = {2{arbiter_1_firstHot_1}} ;
  assign SEXT_arbiter_1_firstHot_692_693_BIT_0_694_AND__ETC___d1708 =
	     x__h63114 | y__h63115 ;
  assign SEXT_arbiter_1_firstHot__q9 = {2{arbiter_1_firstHot}} ;
  assign SEXT_arbiter_1_lastSelect_1_687_688_BIT_0_689__ETC___d1702 =
	     x__h62978 | y__h62979 ;
  assign SEXT_arbiter_1_lastSelect_1__q11 = {2{arbiter_1_lastSelect_1}} ;
  assign SEXT_arbiter_1_lastSelect_2_146_147_BIT_0_148__ETC___d2154 =
	     x__h82584 | y__h82585 ;
  assign SEXT_arbiter_1_lastSelect_2__q16 = {2{arbiter_1_lastSelect_2}} ;
  assign SEXT_arbiter_1_lastSelect_683_684_BIT_0_685_AN_ETC___d1696 =
	     x__h62827 | y__h62828 ;
  assign SEXT_arbiter_1_lastSelect__q10 = {2{arbiter_1_lastSelect}} ;
  assign SEXT_arbiter_firstHot_497_498_BIT_0_499_AND_re_ETC___d1505 =
	     x__h48738 | y__h48739 ;
  assign SEXT_arbiter_firstHot__q5 = {2{arbiter_firstHot}} ;
  assign SEXT_arbiter_lastSelect_493_494_BIT_0_495_AND__ETC___d1501 =
	     x__h48635 | y__h48636 ;
  assign SEXT_arbiter_lastSelect__q6 = {2{arbiter_lastSelect}} ;
  assign SEXT_x3111__q18 = {2{x__h83111}} ;
  assign SEXT_x3648__q13 = {2{x__h63648}} ;
  assign SEXT_x3682__q14 = {2{x__h63682}} ;
  assign SEXT_x5056__q23 = {2{x__h95056}} ;
  assign SEXT_x5090__q24 = {2{x__h95090}} ;
  assign SEXT_x9162__q8 = {2{x__h49162}} ;
  assign _0_CONCAT_tagController_tmp_tagCon_memory_reque_ETC___d245 =
	     x__h12609 + y__h12610 ;
  assign a_awid__h38608 = { 1'd0, proc$master1_awid } ;
  assign a_awid__h41374 = { 1'd1, debug_module$master_awid } ;
  assign araddr__h15532 =
	     { 24'd0, tagController_tmp_tagCon$memory_request_get[140:101] } ;
  assign arcache__h15537 =
	     tagController_tmp_tagCon$memory_request_get[8] ? 4'd0 : 4'd15 ;
  assign arlen__h15533 =
	     { 5'd0, tagController_tmp_tagCon$memory_request_get[5:3] } ;
  assign aw_awaddr__h10800 = tmp__h10583 + { 60'd0, x__h10875 } ;
  assign aw_awsize_val__h12539 =
	     _0_CONCAT_tagController_tmp_tagCon_memory_reque_ETC___d245[0] ?
	       3'd0 :
	       (_0_CONCAT_tagController_tmp_tagCon_memory_reque_ETC___d245[1] ?
		  3'd1 :
		  (_0_CONCAT_tagController_tmp_tagCon_memory_reque_ETC___d245[2] ?
		     3'd2 :
		     (_0_CONCAT_tagController_tmp_tagCon_memory_reque_ETC___d245[3] ?
			3'd3 :
			3'd4))) ;
  assign debug_module_master_ar_araddr__944_BITS_63_TO__ETC___d1958 =
	     debug_module$master_araddr[63:40] == 24'd0 &&
	     (debug_module_master_ar_araddr__944_ULT_soc_map_ETC___d1947 ||
	      !debug_module_master_ar_araddr__944_MINUS_soc_m_ETC___d1949) &&
	     (debug_module_master_ar_araddr__944_ULT_soc_map_ETC___d1952 ||
	      !debug_module_master_ar_araddr__944_MINUS_soc_m_ETC___d1954) ;
  assign debug_module_master_ar_araddr__944_BITS_63_TO__ETC___d1963 =
	     debug_module$master_araddr[63:40] == 24'd0 &&
	     (debug_module_master_ar_araddr__944_ULT_soc_map_ETC___d1947 ||
	      !debug_module_master_ar_araddr__944_MINUS_soc_m_ETC___d1949) &&
	     !debug_module_master_ar_araddr__944_ULT_soc_map_ETC___d1952 &&
	     debug_module_master_ar_araddr__944_MINUS_soc_m_ETC___d1954 ;
  assign debug_module_master_ar_araddr__944_MINUS_soc_m_ETC___d1949 =
	     x__h74407 < soc_map$m_mem0_controller_addr_range[63:0] ;
  assign debug_module_master_ar_araddr__944_MINUS_soc_m_ETC___d1954 =
	     x__h74432 < soc_map$m_plic_addr_range[63:0] ;
  assign debug_module_master_ar_araddr__944_ULT_soc_map_ETC___d1947 =
	     debug_module$master_araddr <
	     soc_map$m_mem0_controller_addr_range[127:64] ;
  assign debug_module_master_ar_araddr__944_ULT_soc_map_ETC___d1952 =
	     debug_module$master_araddr < soc_map$m_plic_addr_range[127:64] ;
  assign fatReq_arid__h72495 = { 1'd0, proc$master1_arid } ;
  assign fatReq_arid__h74960 = { 1'd1, debug_module$master_arid } ;
  assign proc_master1_ar_araddr__852_BITS_63_TO_40_853__ETC___d1866 =
	     proc$master1_araddr[63:40] == 24'd0 &&
	     (proc_master1_ar_araddr__852_ULT_soc_map_m_mem0_ETC___d1855 ||
	      !proc_master1_ar_araddr__852_MINUS_soc_map_m_me_ETC___d1857) &&
	     (proc_master1_ar_araddr__852_ULT_soc_map_m_plic_ETC___d1860 ||
	      !proc_master1_ar_araddr__852_MINUS_soc_map_m_pl_ETC___d1862) ;
  assign proc_master1_ar_araddr__852_BITS_63_TO_40_853__ETC___d1871 =
	     proc$master1_araddr[63:40] == 24'd0 &&
	     (proc_master1_ar_araddr__852_ULT_soc_map_m_mem0_ETC___d1855 ||
	      !proc_master1_ar_araddr__852_MINUS_soc_map_m_me_ETC___d1857) &&
	     !proc_master1_ar_araddr__852_ULT_soc_map_m_plic_ETC___d1860 &&
	     proc_master1_ar_araddr__852_MINUS_soc_map_m_pl_ETC___d1862 ;
  assign proc_master1_ar_araddr__852_MINUS_soc_map_m_me_ETC___d1857 =
	     x__h71927 < soc_map$m_mem0_controller_addr_range[63:0] ;
  assign proc_master1_ar_araddr__852_MINUS_soc_map_m_pl_ETC___d1862 =
	     x__h71952 < soc_map$m_plic_addr_range[63:0] ;
  assign proc_master1_ar_araddr__852_ULT_soc_map_m_mem0_ETC___d1855 =
	     proc$master1_araddr <
	     soc_map$m_mem0_controller_addr_range[127:64] ;
  assign proc_master1_ar_araddr__852_ULT_soc_map_m_plic_ETC___d1860 =
	     proc$master1_araddr < soc_map$m_plic_addr_range[127:64] ;
  assign reqWires_1_0_whas__669_AND_reqWires_1_0_wget___ETC___d1679 =
	     CAN_FIRE_RL_craftReq_2 && reqWires_1_0$wget ||
	     CAN_FIRE_RL_craftReq_3 && reqWires_1_1$wget ||
	     CAN_FIRE_RL_craftReq_4 && reqWires_1_2$wget ;
  assign reqWires_1_1_0_whas__312_AND_reqWires_1_1_0_wg_ETC___d2322 =
  ...
  assign split_0_doPut_whas__086_AND_split_0_doPut_wget_ETC___d1093 =
	     CAN_FIRE_RL_sink_selected &&
	     (split_0_doPut$wget[172] ||
	      ssNoSynth_0_aw_buffer_ff$FULL_N &&
	      ssNoSynth_0_w_buffer_ff$FULL_N) ;
  assign split_1_doPut_whas__115_AND_split_1_doPut_wget_ETC___d1122 =
	     CAN_FIRE_RL_sink_selected_1 &&
	     (split_1_doPut$wget[172] ||
	      ssNoSynth_1_aw_buffer_ff$FULL_N &&
	      ssNoSynth_1_w_buffer_ff$FULL_N) ;
  assign split_2_doPut_whas__144_AND_split_2_doPut_wget_ETC___d1151 =
	     CAN_FIRE_RL_sink_selected_2 &&
	     (split_2_doPut$wget[172] ||
	      ssNoSynth_2_aw_buffer_ff$FULL_N &&
	      ssNoSynth_2_w_buffer_ff$FULL_N) ;
  assign state_1_1_143_AND_activeSource_1_0_1_210_211_A_ETC___d2213 =
	     state_1_1 && activeSource_1_0_1 && ifcs_0_1_innerRoute$EMPTY_N &&
	     ((!ifcs_0_1_innerRoute$D_OUT[0] ||
	       !ssNoSynth_0_ar_buffer_ff$FULL_N) ?
		IF_NOT_ifcs_0_1_innerRoute_first__096_BIT_1_10_ETC___d2118 :
		ifcs_0_1_innerRoute$D_OUT[0]) ;
  assign state_1_1_143_AND_activeSource_1_1_1_250_251_A_ETC___d2253 =
	     state_1_1 && activeSource_1_1_1 && ifcs_1_1_innerRoute$EMPTY_N &&
	     ((!ifcs_1_1_innerRoute$D_OUT[0] ||
	       !ssNoSynth_0_ar_buffer_ff$FULL_N) ?
		IF_NOT_ifcs_1_1_innerRoute_first__125_BIT_1_12_ETC___d2134 :
		ifcs_1_1_innerRoute$D_OUT[0]) ;
  assign state_1_1_1_323_AND_activeSource_1_1_0_417_418_ETC___d2420 =
		...
		!CAN_FIRE_RL_ifcs_1_1_drainNoRouteResponse :
		ifcs_0_1_routeBack$D_OUT[0]) ;
  assign state_1_1_1_323_AND_activeSource_1_1_1_1_453_4_ETC___d2456 =
		...
		!CAN_FIRE_RL_ifcs_1_1_drainNoRouteResponse :
		ifcs_1_1_routeBack$D_OUT[0]) ;
  assign state_1_1_1_323_AND_activeSource_1_1_2_489_490_ETC___d2492 =
		...
		!CAN_FIRE_RL_ifcs_1_1_drainNoRouteResponse :
		ifcs_2_1_routeBack$D_OUT[0]) ;
  assign state_1_680_AND_activeSource_1_0_768_769_AND_i_ETC___d1771 =
		...
		!CAN_FIRE_RL_ifcs_1_drainNoRouteResponse :
		ifcs_0_routeBack$D_OUT[0]) ;
  assign state_1_680_AND_activeSource_1_1_801_802_AND_i_ETC___d1804 =
		...
		!CAN_FIRE_RL_ifcs_1_drainNoRouteResponse :
		ifcs_1_routeBack$D_OUT[0]) ;
  assign state_1_680_AND_activeSource_1_2_835_836_AND_i_ETC___d1838 =
		...
		!CAN_FIRE_RL_ifcs_1_drainNoRouteResponse :
		ifcs_2_routeBack$D_OUT[0]) ;
  assign state_490_AND_activeSource_0_563_564_AND_ifcs__ETC___d1566 =
	     state && activeSource_0 && ifcs_0_innerRoute$EMPTY_N &&
	     ((!ifcs_0_innerRoute$D_OUT[0] ||
	       !IF_split_0_flitLeft_094_EQ_0_095_THEN_ssNoSynt_ETC___d1435) ?
		IF_NOT_ifcs_0_innerRoute_first__443_BIT_1_452__ETC___d1465 :
		ifcs_0_innerRoute$D_OUT[0]) ;
  assign state_490_AND_activeSource_1_607_608_AND_ifcs__ETC___d1610 =
  ...
  assign tmp__h10583 = { 24'd0, x__h10832 } ;
  assign tmp__h8358 =
  ...
  assign v_araddr__h15549 =
	     (tagController_tmp_tagCon$memory_request_get[93:92] == 2'd0) ?
	       araddr__h15532 :
	       64'hAAAAAAAAAAAAAAAA ;
  assign v_arid__h15548 =
	     (tagController_tmp_tagCon$memory_request_get[93:92] == 2'd0) ?
	       tagController_tmp_tagCon$memory_request_get[100:95] :
	       6'd0 ;
  assign v_arlen__h15550 =
	     (tagController_tmp_tagCon$memory_request_get[93:92] == 2'd0) ?
	       arlen__h15533 :
	       8'd0 ;
  assign v_arsize_val__h15595 =
	     (tagController_tmp_tagCon$memory_request_get[93:92] == 2'd0) ?
			...
			(tagController_tmp_tagCon$memory_request_get[85] ?
			   ...
			   (tagController_tmp_tagCon$memory_request_get[86] ?
				 ...
				 (tagController_tmp_tagCon$memory_request_get[88] ?
				    4'd7 :
				    4'd8))))))) ;
  assign x__h12609 = x__h12621 + y__h12622 ;
  assign x__h12621 = x__h12633 + y__h12634 ;
  assign x__h12633 = x__h12645 + y__h12646 ;
  assign x__h12645 = x__h12657 + y__h12658 ;
  assign x__h12657 = x__h12669 + y__h12670 ;
  assign x__h12669 = x__h12681 + y__h12682 ;
  assign x__h12681 =
  ...
  assign x__h37445 =
	     proc$master1_awaddr -
	     soc_map$m_mem0_controller_addr_range[127:64] ;
  assign x__h37480 = proc$master1_awaddr - soc_map$m_plic_addr_range[127:64] ;
  assign x__h40257 =
	     debug_module$master_awaddr -
	     soc_map$m_mem0_controller_addr_range[127:64] ;
  assign x__h40282 =
  ...
  assign x__h48738 =
	     ...
	     (CAN_FIRE_RL_craftReq && reqWires_0$wget) ;
  assign x__h49103 =
	     SEXT_SEXT_arbiter_firstHot_497_498_BIT_0_499_A_ETC__q7[0] &
	     arbiter_firstHot ;
  assign x__h49162 =
	     !SEXT_arbiter_firstHot_497_498_BIT_0_499_AND_re_ETC___d1505 &&
	     SEXT_arbiter_lastSelect_493_494_BIT_0_495_AND__ETC___d1501 ;
  assign x__h49244 = SEXT_x9162__q8[0] & arbiter_firstHot ;
  assign x__h62827 = x__h62829 | y__h62830 ;
  assign x__h62829 =
	     SEXT_arbiter_1_lastSelect__q10[0] &
	     (CAN_FIRE_RL_craftReq_2 && reqWires_1_0$wget) ;
  assign x__h62978 = x__h62980 | y__h62981 ;
  assign x__h62980 =
	     SEXT_arbiter_1_lastSelect_1__q11[0] &
	     (CAN_FIRE_RL_craftReq_2 && reqWires_1_0$wget) ;
  assign x__h63114 = x__h63116 | y__h63117 ;
  assign x__h63116 =
	     SEXT_arbiter_1_firstHot__q9[0] &
	     (CAN_FIRE_RL_craftReq_2 && reqWires_1_0$wget) ;
  assign x__h63586 = x__h63588 | y__h63589 ;
  assign x__h63588 =
	     SEXT_SEXT_arbiter_1_firstHot_692_693_BIT_0_694_ETC__q12[0] &
	     arbiter_1_firstHot ;
  assign x__h63648 =
	     !SEXT_arbiter_1_firstHot_692_693_BIT_0_694_AND__ETC___d1708 &&
	     SEXT_arbiter_1_lastSelect_1_687_688_BIT_0_689__ETC___d1702 ;
  assign x__h63682 =
	     ...
	     !SEXT_arbiter_1_firstHot_692_693_BIT_0_694_AND__ETC___d1708 &&
	     SEXT_arbiter_1_lastSelect_683_684_BIT_0_685_AN_ETC___d1696 ;
  assign x__h63774 = x__h63776 | y__h63777 ;
  assign x__h63776 = SEXT_x3648__q13[0] & arbiter_1_firstHot ;
  assign x__h63955 = x__h63957 | y__h63958 ;
  assign x__h63957 = SEXT_x3682__q14[0] & arbiter_1_firstHot ;
  assign x__h71927 =
	     proc$master1_araddr -
	     soc_map$m_mem0_controller_addr_range[127:64] ;
  assign x__h71952 = proc$master1_araddr - soc_map$m_plic_addr_range[127:64] ;
  assign x__h74407 =
	     debug_module$master_araddr -
	     soc_map$m_mem0_controller_addr_range[127:64] ;
  assign x__h74432 =
  ...
  assign x__h82687 =
	     ...
	     (CAN_FIRE_RL_craftReq_5 && reqWires_1_0_1$wget) ;
  assign x__h83052 =
	     SEXT_SEXT_arbiter_1_firstHot_1_150_151_BIT_0_1_ETC__q17[0] &
	     arbiter_1_firstHot_1 ;
  assign x__h83111 =
	     !SEXT_arbiter_1_firstHot_1_150_151_BIT_0_152_AN_ETC___d2158 &&
	     SEXT_arbiter_1_lastSelect_2_146_147_BIT_0_148__ETC___d2154 ;
  assign x__h83193 = SEXT_x3111__q18[0] & arbiter_1_firstHot_1 ;
  assign x__h94235 = x__h94237 | y__h94238 ;
  assign x__h94237 =
	     SEXT_arbiter_1_1_lastSelect__q20[0] &
	     (CAN_FIRE_RL_craftReq_7 && reqWires_1_1_0$wget) ;
  assign x__h94386 = x__h94388 | y__h94389 ;
  assign x__h94388 =
	     SEXT_arbiter_1_1_lastSelect_1__q21[0] &
	     (CAN_FIRE_RL_craftReq_7 && reqWires_1_1_0$wget) ;
  assign x__h94522 = x__h94524 | y__h94525 ;
  assign x__h94524 =
	     SEXT_arbiter_1_1_firstHot__q19[0] &
	     (CAN_FIRE_RL_craftReq_7 && reqWires_1_1_0$wget) ;
  assign x__h94994 = x__h94996 | y__h94997 ;
  assign x__h94996 =
	     SEXT_SEXT_arbiter_1_1_firstHot_335_336_BIT_0_3_ETC__q22[0] &
	     arbiter_1_1_firstHot ;
  assign x__h95056 =
	     !SEXT_arbiter_1_1_firstHot_335_336_BIT_0_337_AN_ETC___d2351 &&
	     SEXT_arbiter_1_1_lastSelect_1_330_331_BIT_0_33_ETC___d2345 ;
  ...
  assign x__h95184 = SEXT_x5056__q23[0] & arbiter_1_1_firstHot ;
  assign x__h95363 = x__h95365 | y__h95366 ;
  assign x__h95365 = SEXT_x5090__q24[0] & arbiter_1_1_firstHot ;
  assign x_port1__read__h73054 =
	     CAN_FIRE_RL_ifcs_0_1_nonRoutableFlit ?
	       ifcs_0_1_noRoute_flitCount$port0__write_1 :
	       ifcs_0_1_noRoute_flitCount ;
  assign x_port1__read__h75518 =
	     CAN_FIRE_RL_ifcs_1_1_nonRoutableFlit ?
	       ifcs_1_1_noRoute_flitCount$port0__write_1 :
	       ifcs_1_1_noRoute_flitCount ;
  assign x_rdata__h25037 =
	     msNoSynth_0_r_buffer_ff$EMPTY_N ?
	       msNoSynth_0_r_buffer_ff$D_OUT[67:4] :
	       msNoSynth_0_r_buffer_enqw$wget[67:4] ;
  assign x_rid__h25036 =
	     msNoSynth_0_r_buffer_ff$EMPTY_N ?
  ...
  assign y__h48739 =
	     SEXT_arbiter_lastSelect__q6[0] &
	     (CAN_FIRE_RL_craftReq_1 && reqWires_1$wget) ;
  assign y__h49104 = SEXT_x9162__q8[0] & arbiter_lastSelect ;
  assign y__h49245 =
	     SEXT_SEXT_arbiter_firstHot_497_498_BIT_0_499_A_ETC__q7[0] &
	     arbiter_lastSelect ;
  assign y__h62828 =
  ...
  assign y__h63117 =
	     SEXT_arbiter_1_lastSelect__q10[0] &
	     (CAN_FIRE_RL_craftReq_3 && reqWires_1_1$wget) ;
  assign y__h63587 = SEXT_x3682__q14[0] & arbiter_1_lastSelect ;
  assign y__h63589 = SEXT_x3648__q13[0] & arbiter_1_lastSelect_1 ;
  assign y__h63775 =
	     SEXT_SEXT_arbiter_1_firstHot_692_693_BIT_0_694_ETC__q12[0] &
	     arbiter_1_lastSelect ;
  assign y__h63777 = SEXT_x3682__q14[0] & arbiter_1_lastSelect_1 ;
  assign y__h63956 = SEXT_x3648__q13[0] & arbiter_1_lastSelect ;
  assign y__h63958 =
	     SEXT_SEXT_arbiter_1_firstHot_692_693_BIT_0_694_ETC__q12[0] &
	     arbiter_1_lastSelect_1 ;
  assign y__h82585 =
  ...
  assign y__h82688 =
	     SEXT_arbiter_1_lastSelect_2__q16[0] &
	     (CAN_FIRE_RL_craftReq_6 && reqWires_1_1_1$wget) ;
  assign y__h83053 = SEXT_x3111__q18[0] & arbiter_1_lastSelect_2 ;
  assign y__h83194 =
	     SEXT_SEXT_arbiter_1_firstHot_1_150_151_BIT_0_1_ETC__q17[0] &
	     arbiter_1_lastSelect_2 ;
  assign y__h94236 =
  ...
  assign y__h94525 =
	     SEXT_arbiter_1_1_lastSelect__q20[0] &
	     (CAN_FIRE_RL_craftReq_8 && reqWires_1_1_1_1$wget) ;
  assign y__h94995 = SEXT_x5090__q24[0] & arbiter_1_1_lastSelect ;
  assign y__h94997 = SEXT_x5056__q23[0] & arbiter_1_1_lastSelect_1 ;
  assign y__h95183 =
	     SEXT_SEXT_arbiter_1_1_firstHot_335_336_BIT_0_3_ETC__q22[0] &
	     arbiter_1_1_lastSelect ;
  assign y__h95185 = SEXT_x5090__q24[0] & arbiter_1_1_lastSelect_1 ;
  assign y__h95364 = SEXT_x5056__q23[0] & arbiter_1_1_lastSelect ;
  assign y__h95366 =
	     SEXT_SEXT_arbiter_1_1_firstHot_335_336_BIT_0_3_ETC__q22[0] &
	     arbiter_1_1_lastSelect_1 ;
  ...
  begin
    ...
    if (hart0_reset$RST_OUT != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ug_uncached_mem_shim_master_u_aw_warnDoDrop)
	$display("WARNING: dropping from Source that can't be dropped from");
    if (hart0_reset$RST_OUT != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ug_uncached_mem_shim_master_u_w_warnDoDrop)
	$display("WARNING: dropping from Source that can't be dropped from");
    if (hart0_reset$RST_OUT != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ug_uncached_mem_shim_master_u_b_warnDoPut)
	$display("WARNING: putting into a Sink that can't be put into");
    if (hart0_reset$RST_OUT != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ug_uncached_mem_shim_master_u_ar_warnDoDrop)
	$display("WARNING: dropping from Source that can't be dropped from");
    if (hart0_reset$RST_OUT != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ug_uncached_mem_shim_master_u_r_warnDoPut)
	$display("WARNING: putting into a Sink that can't be put into");
    if (hart0_reset$RST_OUT != `BSV_RESET_VALUE)
