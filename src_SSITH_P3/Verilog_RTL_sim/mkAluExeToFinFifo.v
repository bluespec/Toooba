...
module mkAluExeToFinFifo(CLK,
  ...
  reg [1 : 0] CASE_enq_x_BITS_754_TO_753_0_enq_x_BITS_754_TO_ETC__q2,
	      CASE_m_m_row_0_BITS_742_TO_741_0_m_m_row_0_BIT_ETC__q1;
  wire [11 : 0] sb__h5571, upd__h1154;
  ...
  assign m_m_specBits_0_lat_1$wget =
	     sb__h5571 & specUpdate_correctSpeculation_mask ;

  // register m_m_row_0
  assign m_m_row_0$D_IN =
	     { enq_x[968:755],
	       CASE_enq_x_BITS_754_TO_753_0_enq_x_BITS_754_TO_ETC__q2,
	       enq_x[752:12] } ;
  assign m_m_row_0$EN = EN_enq ;

  // register m_m_specBits_0_rl
  assign m_m_specBits_0_rl$D_IN =
	     EN_specUpdate_correctSpeculation ? upd__h1154 : sb__h5571 ;
  ...
  assign _dand1m_m_valid_0_lat_1$EN_wset =
	     ...
	     (specUpdate_incorrectSpeculation_kill_all ||
	      m_m_specBits_0_rl[specUpdate_incorrectSpeculation_kill_tag]) ;
  assign sb__h5571 = EN_enq ? enq_x[11:0] : m_m_specBits_0_rl ;
  ...
  begin
    case (enq_x[754:753])
	  ...
	  CASE_enq_x_BITS_754_TO_753_0_enq_x_BITS_754_TO_ETC__q2 =
	      enq_x[754:753];
      default: CASE_enq_x_BITS_754_TO_753_0_enq_x_BITS_754_TO_ETC__q2 = 2'd2;
    endcase
  end
