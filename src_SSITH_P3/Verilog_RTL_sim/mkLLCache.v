...
//
// On Mon Jun 29 23:41:29 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkLLCache(CLK,
  ...
  begin
    case (cache_toCQ_deqP)
      1'd0: x__h503463 = cache_toCQ_data_0[0];
      1'd1: x__h503463 = cache_toCQ_data_1[0];
    endcase
  end
  always@(cache_toCQ_deqP or cache_toCQ_data_0 or cache_toCQ_data_1)
  begin
    case (cache_toCQ_deqP)
      1'd0: x__h503508 = cache_toCQ_data_0[520];
      1'd1: x__h503508 = cache_toCQ_data_1[520];
    endcase
  end
  always@(cache_toCQ_deqP or cache_toCQ_data_0 or cache_toCQ_data_1)
  begin
    case (cache_toCQ_deqP)
      1'd0: x__h506630 = cache_toCQ_data_0[2:0];
      1'd1: x__h506630 = cache_toCQ_data_1[2:0];
    endcase
  end
  always@(cache_toMQ_deqP or cache_toMQ_data_0 or cache_toMQ_data_1)
  begin
    case (cache_toMQ_deqP)
      1'd0: x__h520773 = cache_toMQ_data_0[3:0];
      1'd1: x__h520773 = cache_toMQ_data_1[3:0];
    endcase
  end
