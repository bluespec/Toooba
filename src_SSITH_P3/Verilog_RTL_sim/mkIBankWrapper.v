...
module mkIBankWrapper(CLK,
  ...
  reg [31 : 0] CASE_m_cRqMshrpipelineResp_getRq_BITS_5_TO_2__ETC__q37,
	       CASE_sel1593_0_m_pipelinefirst_BITS_31_TO_0_1_ETC__q36;
  ...
  assign sel__h51593 = m_cRqMshr$pipelineResp_getRq[5:2] + 4'd1 ;
  assign v__h10212 =
	     IF_m_rsToPQ_enqReq_lat_1_whas__1_THEN_m_rsToPQ_ETC___d40 ?
	       v__h10363 :
	       m_rsToPQ_enqP ;
  ...
  always@(sel__h51593 or m_pipeline$first)
  begin
    case (sel__h51593)
      4'd0:
	  CASE_sel1593_0_m_pipelinefirst_BITS_31_TO_0_1_ETC__q36 =
