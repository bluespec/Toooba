...
//
// On Wed Jun 17 12:28:29 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkIBankWrapper(CLK,
  ...
  wire [574 : 0] MUX_m_pipeline$deqWrite_2__VAL_1,
  ...
  reg [31 : 0] CASE_m_cRqMshrpipelineResp_getRq_BITS_5_TO_2__ETC__q37,
	       CASE_sel1595_0_m_pipelinefirst_BITS_31_TO_0_1_ETC__q36;
  ...
  wire [58 : 0] IF_m_cRqMshr_pipelineResp_searchEndOfChain_m_c_ETC___d615,
  ...
  wire IF_IF_m_fromPQ_deqReq_lat_1_whas__30_THEN_m_fr_ETC___d360,
       ...
       m_pipeline_first__60_BITS_574_TO_522_73_EQ_m_c_ETC___d575,
  ...
  assign MUX_m_rsToPIndexQ$enq_1__SEL_1 =
	     WILL_FIRE_RL_m_pipelineResp_pRq && !m_pipeline$first[575] ;
  ...
  assign MUX_m_cRqMshr$pipelineResp_setStateSlot_3__VAL_2 =
	     m_pipeline$first[519] ?
		  ...
		  ((m_pipeline$first[521:520] == 2'd0 ||
		    m_pipeline_first__60_BITS_574_TO_522_73_EQ_m_c_ETC___d575) ?
		     { m_pipeline$first[578:576], 54'h15555555555555 } :
		     { m_pipeline$first[578:576],
		       m_pipeline$first[574:522],
		       1'd1 })) ;
  ...
  assign MUX_m_pipeline$deqWrite_2__VAL_3 =
	     m_pipeline$first[575] ?
	       m_pipeline$first[574:0] :
	       { m_pipeline$first[574:522],
  ...
  assign MUX_m_rsToPIndexQ$enq_1__VAL_1 =
	     { 1'd1, m_pipeline$first[581:579] } ;
  assign MUX_m_rsToPIndexQ$enq_1__VAL_2 =
	     { 1'd0, m_pipeline$first[581:579] } ;
  ...
  assign m_cRqMshr$pipelineResp_getRq_n =
	     (m_pipeline$first[583:582] == 2'd0) ?
	       m_pipeline$first[581:579] :
	       (m_pipeline$first[519] ? m_pipeline$first[518:516] : 3'd0) ;
  assign m_cRqMshr$pipelineResp_getSlot_n = m_pipeline$first[581:579] ;
  ...
  assign m_pRqMshr$pipelineResp_getRq_n = m_pipeline$first[580:579] ;
  ...
  // submodule m_rqToPIndexQ_pipelineResp
  assign m_rqToPIndexQ_pipelineResp$D_IN = m_pipeline$first[581:579] ;
  ...
  assign m_pipeline_first__60_BITS_518_TO_516_65_EQ_m_p_ETC___d587 =
	     m_pipeline$first[518:516] == m_pipeline$first[581:579] ;
  assign m_pipeline_first__60_BITS_574_TO_522_73_EQ_m_c_ETC___d575 =
	     m_pipeline$first[574:522] ==
	     m_cRqMshr$pipelineResp_getRq[63:11] ;
  ...
  assign sel__h51595 = m_cRqMshr$pipelineResp_getRq[5:2] + 4'd1 ;
  assign v__h10212 =
	     IF_m_rsToPQ_enqReq_lat_1_whas__1_THEN_m_rsToPQ_ETC___d40 ?
	       v__h10363 :
	       m_rsToPQ_enqP ;
  ...
  always@(sel__h51595 or m_pipeline$first)
  begin
    case (sel__h51595)
      4'd0:
	  CASE_sel1595_0_m_pipelinefirst_BITS_31_TO_0_1_ETC__q36 =
  ...
  begin
	...
	$fdisplay(32'h80000002, "\n%m: ASSERT FAIL!!");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_m_pipelineResp_pRq && !m_pipeline$first[575] &&
	  (m_pipeline$first[521:520] != 2'd1 ||
	   m_pRqMshr$pipelineResp_getRq[1:0] != 2'd0 ||
	   m_pipeline$first[574:522] != m_pRqMshr$pipelineResp_getRq[65:13]))
	$fdisplay(32'h80000002, "\n%m: ASSERT FAIL!!");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_m_pipelineResp_pRq && !m_pipeline$first[575] &&
	  m_pipeline$first[519])
