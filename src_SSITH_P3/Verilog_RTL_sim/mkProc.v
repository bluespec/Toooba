...
//
// On Mon Jul  6 19:13:43 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkProc(CLK,
  ...
  reg [63 : 0] CASE_llc_axi4_adapter_rg_wr_req_beat_BIT_0_0_l_ETC__q1,
	       ...
	       CASE_x00998_0_IF_CAN_FIRE_RL_srcPropose_THEN_p_ETC__q14,
	       CASE_x23284_0_IF_CAN_FIRE_RL_srcPropose_2_THEN_ETC__q15,
	       ...
	       CASE_x23284_0_IF_CAN_FIRE_RL_srcPropose_2_THEN_ETC__q24,
  ...
  reg [7 : 0] v_wstrb__h218244, wflit_wstrb__h17688;
  reg [5 : 0] IF_mmioPlatform_reqFunc_04_BITS_5_TO_4_05_EQ_0_ETC___d846;
  reg [2 : 0] x__h101198;
  reg [1 : 0] CASE_x00998_0_IF_CAN_FIRE_RL_srcPropose_THEN_p_ETC__q12,
	      CASE_x00998_0_IF_CAN_FIRE_RL_srcPropose_THEN_p_ETC__q13,
	      CASE_x23284_0_IF_propDstData_1_0_lat_0_whas__5_ETC__q27;
  reg CASE_mmioPlatform_reqFunc_BITS_5_TO_4_0_core_0_ETC__q10,
      ...
      CASE_x23284_0_IF_CAN_FIRE_RL_srcPropose_2_THEN_ETC__q19,
      CASE_x23284_0_IF_CAN_FIRE_RL_srcPropose_2_THEN_ETC__q26,
      CASE_x23284_0_IF_CAN_FIRE_RL_srcPropose_2_THEN_ETC__q28,
  ...
  wire [63 : 0] IF_enqDst_1_0_lat_0_whas__650_THEN_enqDst_1_0__ETC___d1665,
		...
		addr1__h90775,
		data__h141242,
		failed_testnum__h226609,
		line_addr__h140675,
		line_addr__h150786,
		line_addr__h194203,
		mmioPlatform_mtime__h59841,
		newData__h45229,
		newData__h53330,
		v_awaddr__h217772,
		value__h61548,
  ...
  wire [4 : 0] SEL_ARR_IF_propDstData_0_lat_0_whas__436_THEN__ETC___d1541,
	       ...
	       y__h15300,
	       y__h15312;
  wire [3 : 0] b__h194003, b__h2174, mmioPlatform_reqAmofunc__h88545;
  ...
  // inlined wires
  assign mmioPlatform_toHostQ_enqReq_lat_0$wget = { 1'd1, x__h73764 } ;
  ...
  assign llc_axi4_adapter_master_xactor_shim_awff_rv$port0__write_1 =
	     { 6'd32, v_awaddr__h217772, 29'd15532032 } ;
  ...
  assign llc_axi4_adapter_master_xactor_shim_arff_rv$port0__write_1 =
	     { 6'd32, line_addr__h194203, 29'd15532032 } ;
  ...
  assign llc_axi4_adapter_rg_wr_req_beat$D_IN =
	     (llc_axi4_adapter_rg_wr_req_beat == 3'd7) ? 3'd0 : x__h218130 ;
  ...
  // register mmioPlatform_mtimecmp_0
  assign mmioPlatform_mtimecmp_0$D_IN = newData__h45229 ;
  ...
  assign core_0$tlbToMem_respLd_enq_x =
	     { ld_data__h188883, llc$dma_respLd_first[3] } ;
  ...
  module_amoExec instance_amoExec_2(.amoExec_amo_inst(mmioPlatform_reqFunc_04_BITS_3_TO_0_44_CONCAT__ETC___d912),
				    .amoExec_wordIdx({ 1'd0,
						       IF_mmioPlatform_reqBE_07_BITS_7_TO_0_01_EQ_0_0_ETC___d907[4] &&
						       !IF_mmioPlatform_reqBE_07_BITS_7_TO_0_01_EQ_0_0_ETC___d907[0] }),
				    .amoExec_current({ 65'd0, x__h79403 }),
				    .amoExec_inpt({ 65'd0,
						    IF_mmioPlatform_reqBE_07_BITS_7_TO_0_01_EQ_0_0_ETC___d920 }),
				    .amoExec(amoExec___d1134));
  module_amoExec instance_amoExec_4(.amoExec_amo_inst({ mmioPlatform_reqAmofunc__h88545,
							((mmioPlatform_reqBE[0] ?
							    5'd1 :
							    5'd0) +
  ...
  assign IF_NOT_mmioPlatform_reqFunc_04_BITS_5_TO_4_05__ETC___d959 =
	     newData__h45229 <= mmioPlatform_mtime ;
  ...
  assign _theResult____h13492 =
	     (whichHalf___1__h15055 ||
	      mmio_axi4_adapter_f_reqs_from_core$D_OUT[144:137] == 8'd0) ?
	       whichHalf___1__h15055 :
	       mmio_axi4_adapter_rg_wr_req_beat ;
  assign addr1__h90775 = { mmioPlatform_curReq[63:3], 3'b0 } ;
  assign amo_req_data__h39124 =
  ...
  assign llc_mem_server_axi4_slave_xactor_shim_arff_rv__ETC___d2054 =
	     line_addr__h150786 == llc_mem_server_rg_cacheline_cache_addr ;
  assign llc_mem_server_axi4_slave_xactor_shim_awff_rv__ETC___d1953 =
	     line_addr__h140675 == llc_mem_server_rg_cacheline_cache_addr ;
  ...
  assign lower_data__h44530 =
	     mmioPlatform_waitLowerMSIPCRs ? v__h44423 : 32'd0 ;
  ...
  assign mmioPlatform_mtime__h59841 = mmioPlatform_mtime ;
  assign mmioPlatform_mtimecmp_0_01_ULE_IF_NOT_mmioPlat_ETC___d1031 =
	     mmioPlatform_mtimecmp_0 <= newData__h53330 ;
  ...
  assign mmioPlatform_mtip_0_00_OR_NOT_mmioPlatform_mti_ETC___d762 =
	     ...
	     !core_0_mmioToPlatform_cRq_first__23_BITS_214_T_ETC___d525 &&
	     core_0_mmioToPlatform_cRq_first__23_BITS_214_T_ETC___d527 ;
  assign mmioPlatform_reqAmofunc__h88545 = mmioPlatform_reqAmofunc ;
  ...
  assign mmio_axi4_adapter_soc_map_m_is_IO_addr_mmio_ax_ETC___d221 =
	     ...
	     (whichHalf___1__h15055 ||
	      mmio_axi4_adapter_f_reqs_from_core$D_OUT[144:137] == 8'd0 ||
	      !mmio_axi4_adapter_rg_wr_req_beat) ;
  assign newData__h45229 =
	     (mmioPlatform_reqFunc[5:4] != 2'd0 &&
	      mmioPlatform_reqFunc[5:4] != 2'd1 &&
	      mmioPlatform_reqFunc[5:4] != 2'd2) ?
	       amoExec___d922[63:0] :
	       x__h48542 ;
  assign newData__h53330 =
	     (mmioPlatform_reqFunc[5:4] != 2'd0 &&
	      mmioPlatform_reqFunc[5:4] != 2'd1 &&
	      mmioPlatform_reqFunc[5:4] != 2'd2) ?
	       amoExec___d1008[63:0] :
	       x__h56620 ;
  assign upper_data__h44531 =
	     mmioPlatform_waitLowerMSIPCRs ? 32'd0 : v__h44386 ;
  assign v__h44386 = mmioPlatform_waitUpperMSIPCRs ? v__h44423 : 32'd0 ;
  assign v__h44423 = { 31'd0, core_0$mmioToPlatform_cRs_first } ;
  assign v_awaddr__h217772 = { llc$to_mem_toM_first[643:586], 6'h0 } ;
  assign value__h61548 = mmioPlatform_mtimecmp_0 ;
  ...
  assign x__h17619 = mmio_axi4_adapter_rg_wr_req_beat + 1'd1 ;
  assign x__h195056 = llc_axi4_adapter_rg_rd_rsp_beat + 3'd1 ;
  assign x__h218130 = llc_axi4_adapter_rg_wr_req_beat + 3'd1 ;
  assign x__h48542 =
	     { IF_IF_mmioPlatform_reqBE_07_BITS_7_TO_0_01_EQ__ETC___d949,
  ...
  assign x__h73764 =
	     (mmioPlatform_reqFunc[5:4] != 2'd0 &&
	      ...
	      mmioPlatform_reqFunc[5:4] != 2'd2) ?
	       ...
	       x__h64548 ;
  assign x__h79403 = mmioPlatform_fromHostQ_data_0 ;
  assign x_data__h42065 = { 31'd0, mmioPlatform_reqData[0] } ;
  ...
  begin
    case (llc$dma_respLd_first[2:0])
      3'd0: ld_data__h188883 = llc$dma_respLd_first[68:5];
      3'd1: ld_data__h188883 = llc$dma_respLd_first[132:69];
      3'd2: ld_data__h188883 = llc$dma_respLd_first[196:133];
      3'd3: ld_data__h188883 = llc$dma_respLd_first[260:197];
      3'd4: ld_data__h188883 = llc$dma_respLd_first[324:261];
      3'd5: ld_data__h188883 = llc$dma_respLd_first[388:325];
      3'd6: ld_data__h188883 = llc$dma_respLd_first[452:389];
      3'd7: ld_data__h188883 = llc$dma_respLd_first[516:453];
    endcase
  end
  ...
  begin
    case (llc_axi4_adapter_rg_wr_req_beat)
      3'd0: v_wstrb__h218244 = llc$to_mem_toM_first[523:516];
      3'd1: v_wstrb__h218244 = llc$to_mem_toM_first[531:524];
      3'd2: v_wstrb__h218244 = llc$to_mem_toM_first[539:532];
      3'd3: v_wstrb__h218244 = llc$to_mem_toM_first[547:540];
      3'd4: v_wstrb__h218244 = llc$to_mem_toM_first[555:548];
      3'd5: v_wstrb__h218244 = llc$to_mem_toM_first[563:556];
      3'd6: v_wstrb__h218244 = llc$to_mem_toM_first[571:564];
      3'd7: v_wstrb__h218244 = llc$to_mem_toM_first[579:572];
    endcase
  end
  ...
  begin
    case (llc_axi4_adapter_rg_wr_req_beat[2:1])
      2'd0: v_wuser__h218246 = llc$to_mem_toM_first[512];
      2'd1: v_wuser__h218246 = llc$to_mem_toM_first[513];
      2'd2: v_wuser__h218246 = llc$to_mem_toM_first[514];
      2'd3: v_wuser__h218246 = llc$to_mem_toM_first[515];
    endcase
  end
  ...
  begin
    case (llc_mem_server_axi4_slave_xactor_shim_arff_rv$port1__read[34:32])
      3'd0: dword__h150969 = llc_mem_server_rg_cacheline_cache_data[63:0];
      3'd1: dword__h150969 = llc_mem_server_rg_cacheline_cache_data[127:64];
      3'd2: dword__h150969 = llc_mem_server_rg_cacheline_cache_data[191:128];
      3'd3: dword__h150969 = llc_mem_server_rg_cacheline_cache_data[255:192];
      3'd4: dword__h150969 = llc_mem_server_rg_cacheline_cache_data[319:256];
      3'd5: dword__h150969 = llc_mem_server_rg_cacheline_cache_data[383:320];
      3'd6: dword__h150969 = llc_mem_server_rg_cacheline_cache_data[447:384];
      3'd7: dword__h150969 = llc_mem_server_rg_cacheline_cache_data[511:448];
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_tohost && mmioPlatform_toHostQ_data_0 != 64'd0 &&
	  mmioPlatform_toHostQ_data_0[63:1] != 63'd0)
	$display("FAIL %0d", failed_testnum__h226609);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_tohost && mmioPlatform_toHostQ_data_0 != 64'd0)
	$finish(32'd0);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h17351 = v__h17357 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_mmio_axi4_adapter_rl_handle_write_req &&
	  mmio_axi4_adapter_soc_map$m_is_IO_addr &&
	  mmio_axi4_adapter_f_reqs_from_core_first_BITS__ETC___d261)
	$display("%0d: ERROR: CreditCounter: overflow", v__h17351);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_mmio_axi4_adapter_rl_handle_write_req &&
	  mmio_axi4_adapter_soc_map$m_is_IO_addr &&
	  mmio_axi4_adapter_f_reqs_from_core_first_BITS__ETC___d261)
    ...
    v__h17743 = v__h17749 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_mmio_axi4_adapter_rl_handle_write_req &&
	  mmio_axi4_adapter_soc_map$m_is_IO_addr &&
	  mmio_axi4_adapter_cfg_verbosity != 4'd0)
	$display("%d: %m.rl_handle_write_req: sent w flit:", v__h17743);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_mmio_axi4_adapter_rl_handle_write_req &&
	  mmio_axi4_adapter_soc_map$m_is_IO_addr &&
	  mmio_axi4_adapter_cfg_verbosity != 4'd0)
    ...
    v__h20466 = v__h20472 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_mmio_axi4_adapter_rl_discard_write_rsp &&
	  mmio_axi4_adapter_cfg_verbosity != 4'd0)
	$display("%0d: %m.rl_discard_write_rsp", v__h20466);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_mmio_axi4_adapter_rl_discard_write_rsp &&
	  mmio_axi4_adapter_cfg_verbosity != 4'd0)
	$write("    ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_mmioPlatform_processMTimeCmp &&
	  NOT_mmioPlatform_reqFunc_04_BITS_5_TO_4_05_EQ__ETC___d995)
	$write(", new mtimecmp[%d] %x", 1'd0, newData__h45229, "\n");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_mmioPlatform_processMTime &&
	  NOT_mmioPlatform_reqFunc_04_BITS_5_TO_4_05_EQ__ETC___d1067)
	$write(", new mtime %x", newData__h53330, ", mtimecmp ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_mmioPlatform_processMTime &&
	  NOT_mmioPlatform_reqFunc_04_BITS_5_TO_4_05_EQ__ETC___d1067)
	$write("<V ");
    ...
    v__h217878 = v__h217884 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_llc_axi4_adapter_rl_handle_write_req &&
	  llc_axi4_adapter_rg_wr_req_beat == 3'd0 &&
	  llc_axi4_adapter_ctr_wr_rsps_pending_crg == 4'd15)
	$display("%0d: ERROR: CreditCounter: overflow", v__h217878);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_llc_axi4_adapter_rl_handle_write_req &&
	  llc_axi4_adapter_rg_wr_req_beat == 3'd0 &&
	  llc_axi4_adapter_ctr_wr_rsps_pending_crg == 4'd15)
