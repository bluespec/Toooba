...
//
// On Wed Jul 15 02:41:10 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkFpuMulDivRegToExeFifo(CLK,
  ...
  reg [29 : 0] CASE_enq_x_BITS_254_TO_252_0_enq_x_BITS_254_TO_ETC__q2,
	       CASE_m_m_row_0_BITS_242_TO_240_0_m_m_row_0_BIT_ETC__q1;
  wire [11 : 0] sb__h8150, upd__h1154;
  ...
  assign m_m_specBits_0_lat_1$wget =
	     sb__h8150 & specUpdate_correctSpeculation_mask ;

  // register m_m_row_0
  assign m_m_row_0$D_IN =
	     { CASE_enq_x_BITS_254_TO_252_0_enq_x_BITS_254_TO_ETC__q2,
	       enq_x[224:12] } ;
  assign m_m_row_0$EN = EN_enq ;

  // register m_m_specBits_0_rl
  assign m_m_specBits_0_rl$D_IN =
	     EN_specUpdate_correctSpeculation ? upd__h1154 : sb__h8150 ;
  ...
  assign sb__h8150 = EN_enq ? enq_x[11:0] : m_m_specBits_0_rl ;
  ...
  begin
    case (m_m_row_0[242:240])
	  ...
	  CASE_m_m_row_0_BITS_242_TO_240_0_m_m_row_0_BIT_ETC__q1 =
	      m_m_row_0[242:213];
      default: CASE_m_m_row_0_BITS_242_TO_240_0_m_m_row_0_BIT_ETC__q1 =
		   { 3'd5,
  ...
  begin
    case (enq_x[254:252])
	  ...
	  CASE_enq_x_BITS_254_TO_252_0_enq_x_BITS_254_TO_ETC__q2 =
	      enq_x[254:225];
      default: CASE_enq_x_BITS_254_TO_252_0_enq_x_BITS_254_TO_ETC__q2 =
		   { 3'd5,
		     27'bxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  };
    endcase
  end
